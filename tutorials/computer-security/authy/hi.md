---
name: ऑथी 2एफए (दो-कारक प्रमाणीकरण) एक सुरक्षा ऐप है जो आपके ऑनलाइन खातों को सुरक्षित रखने में मदद करता है। यह आपके पासवर्ड के अलावा एक अतिरिक्त सुरक्षा परत जोड़ता है। जब भी आप किसी खाते में लॉगिन करते हैं, तो ऑथी एक विशेष कोड जनरेट करता है जिसे आपको पासवर्ड के साथ दर्ज करना होता है। इससे आपके खाते को अनधिकृत पहुंच से बचाने में मदद मिलती है।
description: 2FA (दो-चरणीय प्रमाणीकरण) एप्लिकेशन का उपयोग कैसे करें?

1. **एप्लिकेशन डाउनलोड करें**: सबसे पहले, अपने स्मार्टफोन पर एक भरोसेमंद 2FA एप्लिकेशन जैसे Google Authenticator या Authy डाउनलोड करें।

2. **खाता सेटअप करें**: जिस खाते के लिए आप 2FA सेट करना चाहते हैं, उसमें लॉगिन करें और सुरक्षा सेटिंग्स में जाएं। वहाँ आपको 2FA विकल्प मिलेगा।

3. **QR कोड स्कैन करें**: 2FA सेटिंग्स में आपको एक QR कोड मिलेगा। अपने 2FA एप्लिकेशन को खोलें और 'स्कैन QR कोड' विकल्प चुनें। अपने फोन के कैमरे से उस कोड को स्कैन करें।

4. **कोड जनरेट करें**: स्कैन करने के बाद, एप्लिकेशन आपके लिए एक 6-अंकीय कोड जनरेट करेगा। यह कोड हर कुछ सेकंड में बदलता रहता है।

5. **कोड दर्ज करें**: अब, अपने खाते की 2FA सेटिंग्स में वापस जाएं और एप्लिकेशन द्वारा जनरेट किया गया कोड दर्ज करें। इससे आपका 2FA सेटअप पूरा हो जाएगा।

6. **सुरक्षित रखें**: सुनिश्चित करें कि आपका 2FA एप्लिकेशन सुरक्षित है और आपके फोन का पासवर्ड या बायोमेट्रिक लॉक सक्रिय है, ताकि कोई और इसे एक्सेस न कर सके।

बस, अब आपका खाता अधिक सुरक्षित है!
---

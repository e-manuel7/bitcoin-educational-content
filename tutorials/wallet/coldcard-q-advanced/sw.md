...
Kabla ya kuanza, hakikisha kuwa una idhini ya kufikia nakala halisi ya maneno yako ya Mnemonic yenye 12- au 24, na uangalie uhalali wake kupitia menyu ifuatayo: `Advanced/Tools > Eneo la Hatari > seed Functions > View seed Words`.
...
Weka passphrase yako kwa kutumia kibodi. Hakikisha umechagua passphrase yenye nguvu (ndefu na bila mpangilio) na ufanye nakala rudufu ya kimwili.
...
Sasa unaweza kubonyeza "*ENTER*" ili kutumia passphrase hii kwenye maneno yako ya Mnemonic na kuamilisha Wallet mpya. Ikiwa ungependa kuhifadhi passphrase hii kwenye microSD, ingiza kadi kwenye slot inayofaa na ubonyeze "*1*".


![CCQ](assets/fr/05.webp)


passphrase yako sasa inatumika. Alama ya ufunguo inaonekana kwenye skrini ya nyumbani na juu ya skrini.


![CCQ](assets/fr/06.webp)


Kila wakati unapofungua COLDCARD Q yako, utahitaji kufikia menyu ya "*passphrase*" na uweke passphrase yako kwa njia sawa na hapo juu, ili kuitumia kwenye Mnemonic iliyohifadhiwa kwenye kifaa na kufikia Bitcoin Wallet sahihi.


![CCQ](assets/fr/07.webp)


Ikiwa umehifadhi passphrase kwenye kadi ya microSD, kila wakati unapoitumia, ingiza kwenye COLDCARD na ufikie menyu ya "*passphrase*". COLDCARD yako itapakia passphrase moja kwa moja kutoka kwa microSD, kwa hivyo hutahitaji kuiingiza wewe mwenyewe. Bonyeza "* Rejesha Imehifadhiwa *".


![CCQ](assets/fr/08.webp)


Angalia kuwa urefu na herufi ya kwanza ya passphrase iliyopakiwa ni sahihi.


![CCQ](assets/fr/09.webp)


Thibitisha kuwa alama ya kidole inayoonyeshwa inalingana na ya Wallet yako na ubofye "*Rejesha*".
...
COLDCARD pia hunufaika kutokana na chaguo nyingi za mchakato wa kufungua kifaa. Wacha tujue zaidi juu ya chaguzi hizi za hali ya juu.
...
Chagua "*Ongeza Hila Mpya*".


![CCQ](assets/fr/12.webp)


Weka msimbo wa PIN utakaohusishwa na kitendo na ukumbuke kuihifadhi.


![CCQ](assets/fr/13.webp)


Kisha chagua kitendo kitakachofanywa kiotomatiki kila unapoingiza PIN hii ya Ujanja. Hapa kuna orodha ya vitendo vinavyopatikana kwa PIN:
...
- "*Futa seed*": Menyu hii inatoa hatua kadhaa za kufuta seed, yaani kuweka upya COLDCARD bila kuiharibu. Tofauti na chaguo la "*Brick Self*", itawezekana kusanidi upya kifaa kwa kutumia nakala rudufu ya maneno yako ya Mnemonic. Walakini, bila nakala hii, bitcoins zako zitapotea. Hapa kuna chaguzi zinazopatikana:
 - "*Futa & Anzisha Upya* : Huondoa seed na kuwasha upya COLDCARD bila kuonyesha taarifa yoyote kwenye skrini.
 - "*Futa Kimya*": Hufuta seed kimyakimya, na kufungua COLDCARD kwenye Wallet bandia ya nasibu kana kwamba hakuna kilichotokea.
 - "*Futa -> Wallet*": Huondoa seed kwa busara na kufungua COLDCARD kwenye Wallet ya upili iliyosanidiwa awali, iliyoundwa kama chambo. Wallet hii inaweza kuwa na sehemu ndogo ya akiba yako ya Bitcoin ili kumridhisha mvamizi.
 - "*Sema Imefutwa, Acha*": Inafuta seed na kuonyesha ujumbe `seed imefutwa, Acha` kwenye skrini.
...
- "*Duress Wallet*": Kwa kitendo hiki, Msimbo wa PIN ya Ujanja hufungua Wallet inayotokana na seed kwa kutumia BIP85. Wallet hii ya pili inaweza kutumika kama chambo kumridhisha mvamizi. COLDCARD hufanya kazi kana kwamba ni Wallet halisi, lakini bila PIN kuu (tofauti na PIN ya Ujanja), mshambuliaji hatawahi kufikia Wallet halisi. Mkakati huu umeundwa ili kuwafanya watu waamini kuwa Wallet iliyounganishwa na PIN ya Ujanja ndiyo pekee iliyopo.
...
- "*Look Blank*": Kitendo hiki hufanya COLDCARD ionekane tupu, na kutoa hisia kwamba seed imefutwa. Kwa kweli, hakuna kinachotokea na seed inabakia sawa. Hii inaiga COLDCARD isiyotumika au iliyowekwa upya.
...
- "*Anzisha Upya Tu* : PIN ya Ujanja inapotumika, COLDCARD huwashwa tena. Hakuna kitendo kingine kinachofanyika.
...
- "*Modi ya Delta*": Kitendo hiki changamano, kilichohifadhiwa kwa watumiaji wenye uzoefu, kimeundwa ili kukabiliana na mashambulizi ya hali ya juu ya kulazimishwa, iwe kutoka kwa serikali au jamaa aliye na taarifa maalum. Hali ya Delta inapowezeshwa, COLDCARD hutoa ufikiaji wa Wallet halisi, kuwezesha mvamizi kusogeza na kuthibitisha kuwa ndiyo Wallet sahihi. Hata hivyo, saini za shughuli zimezuiwa, hivyo kuzuia uhamisho wowote wa Bitcoin. Kwa kuongeza, ufikiaji wa kifungu cha Mnemonic umezimwa na jaribio lolote la kuirejesha litasababisha kufutwa kwake. Ili kuimarisha uaminifu, PIN ya Ujanja inayotumiwa na Hali ya Delta lazima ishiriki kiambishi awali sawa na PIN halisi (ili kuonyesha maneno sawa ya kupinga hadaa), lakini kiambishi tamati lazima kiwe tofauti.


![CCQ](assets/fr/20.webp)


Baada ya kuchagua kitendo, thibitisha chaguo lako.


![CCQ](assets/fr/21.webp)


Kisha unaweza kutazama PIN zote za Ujanja zilizosanidiwa kwenye menyu maalum.


![CCQ](assets/fr/22.webp)


Kwa kuchagua PIN ya Ujanja iliyopo, unaweza kuangalia kitendo kinachohusika. Unaweza pia kuificha kwa "*Ficha Hila*", na kuifanya isionekane kwenye menyu ya PIN ya Ujanja. Unaweza kuifuta kwa kubofya "*Futa Hila*", au kubadilisha msimbo wa PIN huku ukihifadhi kitendo kinachohusishwa na "*Badilisha PIN*".
...
Chaguo la Vifunguo vya Kinyang'anyiro hukuruhusu kuchambua tarakimu zinazoonyeshwa kwenye vitufe vya vitufe vyako unapoingiza msimbo wako wa PIN. Kipengele hiki hulinda usiri wa msimbo wako wa PIN, hata katika tukio la ufuatiliaji wa watu au kamera.


Ili kuamilisha chaguo hili, fikia menyu ya `Mipangilio > Mipangilio ya Kuingia > Vifunguo vya Kinyang'anyiro`.


![CCQ](assets/fr/24.webp)


Chagua chaguo la "*Vifunguo vya Kinyang'anyiro*".


![CCQ](assets/fr/25.webp)


Kuanzia sasa na kuendelea, unapofungua COLDCARD Q yako, vitufe kwenye vitufe vitapewa nambari mpya bila mpangilio kila unapozitumia.
...
Chagua muda wa kuhesabu. Kwa mfano, ukichagua saa 1, utahitaji kusubiri saa 1 kwa kila jaribio la kufungua COLDCARD Q.


![CCQ](assets/fr/28.webp)


Kila wakati unapofungua, utaulizwa kuweka PIN yako.


![CCQ](assets/fr/29.webp)


Kisha subiri muda uliowekwa na siku iliyosalia.


![CCQ](assets/fr/30.webp)


Mwishoni mwa siku iliyosalia, utahitaji kuweka PIN yako tena ili kufikia kifaa.


![CCQ](assets/fr/31.webp)


### Kuingia kwa Calculator


Chaguo hili hukuruhusu kuficha COLDCARD yako kama kikokotoo wakati wa kufungua. Ili kuamilisha kipengele hiki, fikia menyu `Mipangilio > Mipangilio ya Kuingia > Ingia kwenye Kikokotoo`.


![CCQ](assets/fr/32.webp)


Amilisha chaguo kwa kulichagua.


![CCQ](assets/fr/33.webp)


Kuanzia sasa, kila wakati kifaa kinapowashwa, calculator ya kufanya kazi na amri za msingi itaonyeshwa.
...
Ili kufungua COLDCARD kutoka kwa modi ya kikokotoo, anza kwa kuingiza kiambishi awali cha msimbo wako wa PIN ikifuatiwa na deshi. Kwa mfano, ikiwa msimbo wako wa PIN ni `00-00` (msimbo huu ni dhaifu na ni mfano tu, kwa hivyo chagua msimbo thabiti wa PIN), andika `00-`. Kisha COLDCARD itaonyesha maneno yako mawili ya kupinga hadaa.


![CCQ](assets/fr/36.webp)


Kisha ingiza msimbo wako kamili wa PIN, ukitenganishwa na nafasi au deshi, kwa mfano: `00 00`.


![CCQ](assets/fr/37.webp)


Kisha COLDCARD itaondoka kwenye modi ya kikokotoo na kufungua kama kawaida.


## Inaharibu kabisa COLDCARD yako
...
- Ili kuepuka hatari ya mshtuko wa umeme, ondoa betri kutoka kwa kifaa na uitoe kwenye mtandao kabla ya kushughulikia.
- Subiri dakika chache baada ya kuzima kitengo kabla ya kuanza kuchimba visima.
- Vaa glavu zisizo na maboksi na miwani ya usalama ili kuhakikisha usalama wako.


![CCQ](assets/fr/39.webp)


Pindi chips zikishapigwa, usijaribu kuunganisha tena COLDCARD Q.


Hongera, sasa umeboresha chaguo za kina za COLDCARD Q!


Ikiwa umepata mafunzo haya kuwa ya manufaa, ningeshukuru sana ikiwa utaacha kidole gumba cha Green hapa chini. Jisikie huru kushiriki mafunzo haya kwenye mitandao yako ya kijamii. Asante sana!

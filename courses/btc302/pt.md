...
Para criar sua identidade visual, a melhor abordagem é começar com um elemento ou lugar significativo da sua cidade. Isso poderia ser, por exemplo, a Torre Eiffel em Paris, o campanário ou a cidadela em Lille, a rocha Monégasque em Mônaco, o porto antigo em Marselha, etc.
...
Dependendo do seu tempo e desejos, você pode desenvolver outros redes mais tarde; até mesmo **atribuindo a moderação a futuros membros da sua comunidade**.
...
# Organizando um Encontro Bitcoin
...
Procurar um local para organizar seus eventos não é necessariamente simples. No entanto, parece essencial **que este lugar esteja localizado na cidade da sua comunidade**.
...
Por outro lado, do ponto de vista técnico, várias questões podem surgir:
...
![imagem](assets/fr/chapter23/36bis.webp)
...
Nesse sentido, em 2023, foi lançada **a iniciativa "Um White Paper do Bitcoin nas Caixas de Livros da França"**.
...
Quanto à **edição de vídeo** (se houver), você precisará ter um software adequado.
Se você ainda não tem um, o software ["Wondershare Filmora"](https://filmora.wondershare.fr/) é particularmente eficaz e muito fácil de usar; permitindo que você faça edições sérias. Infelizmente, é pago (€45 por ano). Finalmente, para a **introdução e encerramento** do seu vídeo, uma pesquisa específica no **Canva** permitirá que você encontre o que está procurando, modifique os resultados como desejar, baixe-os; e então tudo o que você terá que fazer é integrá-los ao seu software de edição.
Nota: no caso de, um dia, o Bitcoin ser proibido ou censurado, pode ser relevante sempre **manter uma cópia local em um disco rígido dos vídeos** que você postar.

## Criar um podcast de áudio
<chapterId>12e96b45-1c33-5687-a753-80d0114d487a</chapterId>

Criar um podcast de áudio também pode ser uma iniciativa interessante. No entanto, assim como ao criar um canal de vídeo, não espere obter milhares de visualizações rapidamente.

Entre as plataformas de podcast mais conhecidas, encontramos:
- [**Fountain**](https://www.fountain.fm/), que é particularmente interessante porque permite doações diretas em Lightning;
- [**Soundcloud**](https://soundcloud.com/);
- [**Deezer**](https://www.deezer.com/fr/);
- [**Spotify**](https://open.spotify.com/);
- [**Google podcast**](https://podcasts.google.com/).

O problema, no entanto, é que **cada uma dessas plataformas tem um público muito específico**. Assim, para alcançar o maior número de pessoas possível, você precisará estar presente em praticamente todas elas.

Felizmente, a plataforma **["Spotify para podcasters"](https://podcasters.spotify.com/) permite que você importe seu arquivo de podcast uma vez e, em seguida, gere um feed RSS que pode ser copiado e colado em qualquer uma das plataformas mencionadas anteriormente**.
Então, uma vez que o trabalho esteja feito no "Spotify para podcasters", tudo o que resta é a formatação nas suas outras plataformas; o que é relativamente rápido.
####
No caso de você querer **gravar no seu computador, um software gratuito como o ["Audacity"](https://www.audacityteam.org/) funciona muito bem**. Ele permite ajustar muitas configurações, realizar crescendos e até melhorar a clareza do som durante a edição. Gravar sua voz e depois editar o áudio do seu podcast deve ser, portanto, bastante fácil.

Aqui está um breve tutorial apresentando, em 10 minutos, as principais características a conhecer para fazer um podcast com o Audacity.
<videoId>56e302c2-b42c-4a4e-88fc-af207232f5ae</videoId>

Nota: como mencionado antes, no caso de, um dia, o Bitcoin ser proibido ou censurado, pode ser relevante sempre **manter uma cópia local em um disco rígido dos podcasts** que você postar.

## Criar um distintivo para seus eventos
<chapterId>0cccef8d-a765-5844-8921-c40f0ce653e4</chapterId>
Durante seus meet-ups e eventos, é possível projetar um pequeno incentivo para a participação. A ideia seria então **criar um tipo de distintivo que só pode ser obtido no evento em questão**. Isso existe sob o nome de "POAP" ("Proof Of Attendance Protocol") em outras blockchains. No entanto, atualmente, não há uma maneira gratuita de configurar isso no Bitcoin.
Em princípio, esta iniciativa também poderia servir para **recompensar os membros mais envolvidos da sua comunidade, por exemplo, organizando um sorteio anual**, durante o qual um distintivo obtido corresponderia a um bilhete de sorteio. Um membro presente em todos os 12 encontros do ano teria então 12 bilhetes para este sorteio anual.####
Adicionalmente, em uma veia completamente diferente, também é possível **em cada evento pedir aos participantes para escreverem seu primeiro nome ou pseudônimo em um distintivo**. A isso, os motivos de sua presença também podem ser adicionados.
Esta estratégia, embora um pouco formal, pode permitir que alguns membros **encontrem mais facilmente pontos em comum e tópicos de conversa**, além de tornar **mais fácil para os recém-chegados identificar os organizadores** e possíveis membros da associação.

Vários modelos usados pela associação Bitcoin Lille também estão [disponíveis em código aberto no Canva](https://www.canva.com/design/DAGHAsT15MU/AIA7-L_xBjNdsuxdD4-h-Q/edit?utm_content=DAGHAsT15MU&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![imagem](assets/fr/chapter32/52-frter.webp)

## Refletindo sobre a Transição no Evento de Morte
<chapterId>c5febf18-235c-51bc-8fbb-9467dabe4cb0</chapterId>

Outro ponto, em uma nota completamente diferente, é a posição sobre a **morte de um membro da sua comunidade Bitcoin**.
De fato, pode infelizmente chegar o dia em que a família de um dos seus ex-membros entre em contato com você para anunciar que essa pessoa faleceu. Eles então explicarão que **este indivíduo deixou instruções**, e uma delas é **entrar em contato com sua comunidade / encontro / associação**.
Esta pessoa provavelmente explicará que **precisa de ajuda para recuperar os fundos**, pois é beneficiária da herança deste ex-membro.

Em resposta a este pedido, pode ser muito relevante **já ter pensado em um tipo de procedimento a seguir**; e isso, por várias razões.
Por um lado:
- para garantir que o falecido havia pensado antecipadamente em **informar sua família para nunca divulgar ou levar a um encontro as chaves privadas e a(s) carteira(s) física(s) do falecido**;
- para que a família entenda claramente que **sua presença é sobre aprender Bitcoin**, a fim de eventualmente se tornar soberana sobre os fundos do falecido;
- para que **a família esteja ciente da lei que se aplica no país em caso de doação, herança ou conversão em moeda fiduciária**;

Além disso, pensar antecipadamente em um procedimento a seguir também garante que ninguém, seja membro do encontro ou apenas um convidado, possa usar esta situação de qualquer forma para sua vantagem (e/ou para roubar os fundos).

Com este objetivo, pode ser interessante **propor um "grupo de trabalho" sobre o procedimento a adotar em caso de morte e pedidos de ajuda vindos da família**. A associação Bitcoin Lille está realmente trabalhando neste ponto, e compartilhará seu documento de trabalho final de maneira open-source [aqui](https://docs.google.com/document/d/1TDfLZjuictC5s3PEM2Z7WmkxIDSJ8Q1E4xevm52pVgU/edit?usp=sharing) em alguns meses.

## Realizando conferências em escolas e universidades
<chapterId>65efdb44-e3d4-567c-aedf-972765753d73</chapterId>
A lista de projetos anteriormente descrita obviamente não é exaustiva. Em geral, são projetos internos à comunidade/encontros, e podem ser configurados de forma bastante fácil uma vez que sua comunidade tenha se desenvolvido. É, portanto, hora agora de abordar o caso do onboarding.

Antes de tudo, você certamente está ciente de que **uma das melhores maneiras de falar sobre Bitcoin para o maior número possível de pessoas ao mesmo tempo é, obviamente, realizar uma conferência** (ou um workshop). Isso pode ser feito **dentro de escolas pós-secundárias e universidades**; levando assim jovens (e talvez não tão jovens) a descobrir ou aprofundar seu entendimento sobre Bitcoin.

Além da importância de **saber falar em público**, hospedar uma conferência diante de várias dezenas ou até centenas de pessoas requer **saber gerenciar o estresse, a articulação e o tempo**. Também requer **preparar uma apresentação ou workshop de qualidade, fundamentado e alinhado ao nível de habilidade do público** que você enfrentará.
Além disso, **ter uma mentalidade aberta, pronta para simplificar conceitos conforme necessário**, é essencial neste tipo de exercício; especialmente durante a fase de perguntas/respostas e no caso de uma discussão em painel. Isso não significa "abandonar seus princípios"; mas simplesmente aceitar que outros possam ter um ponto de vista diferente, mesmo que isso signifique responder mais tarde ou deixar para lá para que o diálogo possa progredir. De qualquer forma, se **seu discurso e suas respostas forem baseados em argumentos relevantes e fundamentados**, o público não será enganado.
Então, se você se sente capaz: vá em frente! Nosso mundo está em tão grande necessidade de educação sobre o que é Bitcoin...
No entanto, é desnecessário dizer que para realizar essa tarefa, **você precisará de muita motivação, um grande trabalho; mas também, os contatos certos**.

![image](assets/fr/chapter33/53bis.webp)
####
De fato, **organizar uma conferência ou um workshop em uma escola e/ou universidade não é uma tarefa fácil**.
Primeiramente, é necessário **obter um contato**. Isso pode ser alcançado **por meio de um conhecido, através do BDE ("Bureaux Des Étudiants" ou Escritórios dos Estudantes); ou até mesmo associações estudantis**, que geralmente organizam ciclos de conferências e encontros a cada ano. Seus **professores antigos da escola de engenharia e/ou universidade** também podem atuar como intermediários.
No caso de uma escola pós-bacharelado, também é possível **contatar diretamente a pessoa responsável pelo programa de treinamento**, com o objetivo de explicar sua proposta. Isso pode então levar a uma reunião inicial e – no melhor dos mundos, algumas semanas depois – a uma apresentação sobre o que é Bitcoin e como funciona diante dos alunos.
####
Infelizmente, em nosso mundo atual, Bitcoin ainda é muitas vezes deliberadamente demonizado pela mídia e políticos; levando muitos novatos a pensar que deveria ser banido das salas de aula e auditórios. **A probabilidade é, portanto, bastante alta de que você enfrentará muitas rejeições**; especialmente no âmbito acadêmico onde o proof of work do Bitcoin e o consumo de energia às vezes parecem tabu.
No entanto, nada impede de tentar, especialmente com o BDE e associações estudantis. **Com um pouco de sorte, mesmo que a recusa seja firme na primeira vez, não é impossível que você seja contatado novamente durante o próximo bull-run no endereço de e-mail da sua comunidade para realizar uma conferência diante de quase 280 estudantes!**

![image](assets/fr/chapter33/54bis.webp)

## Abordando Empresas
<chapterId>b730462b-7928-5d28-a14f-9ceaa773d3d2</chapterId>
Alcançar o objetivo de **fazer com que o Bitcoin seja aceito como método de pagamento por um comerciante** é algo como o "Santo Graal" para muitos entusiastas do Bitcoin. É como desbloquear uma conquista no seu Pokédex! No entanto, como cada comerciante é diferente, essa tarefa não é fácil; e numerosos problemas surgem:
- **um comerciante ainda precisa de moeda fiduciária para pagar seus fornecedores (por enquanto)**;
- **eles precisam de relatórios financeiros claros e explícitos** que possam ser enviados aos seus contadores;
- **seus métodos de pagamento devem funcionar sem nenhum problema técnico ou logístico**, e os funcionários devem ser capazes de receber pagamentos sem poder fugir com o caixa.

A esses problemas, adicione:
- **os preconceitos potenciais** do comerciante em relação ao Bitcoin;
- **a dificuldade de encontrar uma solução de software** que funcione perfeitamente;
- mas também, **a importância de fazê-los entender os benefícios de aceitar o Bitcoin** como método de pagamento.

![imagem](assets/fr/chapter34/56.webp)
####
Desenvolver o ecossistema Bitcoin na sua cidade pode, portanto, envolver **a adesão de comerciantes**. Para fazer isso, a maneira mais simples é **proceder em etapas**:

1) assim que entrar em uma loja, **sempre pergunte se você pode pagar em Bitcoin**. Isso geralmente resultará em uma recusa e um olhar de questionamento, mas essa simples pergunta gradualmente levará os comerciantes a ver que o Bitcoin pode ser usado por "pessoas normais" e que está ganhando interesse como método de pagamento entre a população. Você pode até **alternar duas ou três pessoas na mesma loja, alguns dias de intervalo, perguntando para pagar em Bitcoin**. Em algum momento, isso chamará a atenção do comerciante;

2) uma vez que eles se tornem interessados ou perguntam o que é Bitcoin, você pode **explicá-lo de forma sucinta e em termos leigos**. Por exemplo, que o Bitcoin é uma moeda, não controlada por bancos, sem um intermediário de confiança, que é inconfiscável, não sujeita à inflação, e que as taxas são menores do que com o sistema bancário tradicional. Você pode então **dar a eles um panfleto**, por exemplo, "21 razões para usar Bitcoin" e/ou "10 razões para aceitar Bitcoin em sua loja", e então **dar a eles seu contato ou o de seu meet-up**. Assim, quando estiverem interessados em uma demonstração, eles podem entrar em contato com você.

3) uma vez que essa pessoa decidiu aceitar Bitcoin, **marcar uma reunião com eles para mostrar a solução de software que você propõe parece apropriado**. **[Swiss Bitcoin Pay](https://swiss-bitcoin-pay.ch/)** apresenta-se como uma excelente solução a este respeito, porque:
- permite que comerciantes que desejam converter seus ganhos diários em bitcoin em moeda fiduciária, possibilitando assim que paguem seus fornecedores;
- também permite, se desejado, manter uma certa porcentagem da receita em BTC;
- possibilita a exportação da contabilidade de todos os pagamentos em bitcoin para enviá-los aos contadores, facilitando assim o trabalho deles;
- tem um painel de controle amigável para o gerente;
- mas também uma interface ergonômica e fácil de usar para os funcionários, que poderão processar pagamentos sem poder fugir com o caixa;
- finalmente, seu custo de uso é mais barato do que a rede bancária tradicional de 2 a 3%.

4) **quando esse negócio aceita Bitcoin**, será então possível para você:
- **visitar regularmente** para fazer compras;
- aproveitar a oportunidade para **perguntar se está tudo indo bem**, até mesmo oferecendo seu contato novamente, se necessário;
- **propor novamente vir aos seus meet-ups e eventos**;
- para **adicionar este negócio no [mapa btcmap.org](https://btcmap.org/)**, e informar [Swiss Bitcoin Pay no Twitter](https://x.com/swissbitcoinpay) para dar visibilidade a este negócio; - mas também para **potencialmente realizar eventos neste negócio**, como meet-ups ou workshops.

![imagem](assets/fr/chapter34/57.webp)

5) uma vez que vários negócios na sua cidade tenham sido integrados e tenham entendido o que o Bitcoin lhes traz, você pode então **propor a criação de um grupo especial no Telegram para comerciantes**; o objetivo sendo **permitir que eles se ajudem mutuamente** e avancem na conversão de outros negócios na cidade para o Bitcoin. Paralelamente, este grupo também pode **atuar como suporte técnico**, caso surja um problema com um cliente.
####
Claro, **esta prospecção é um trabalho de longo prazo. Requer muito tempo, motivação aumentada, mas também um pouco de estratégia**.
Sua comunidade se sente pronta para construir na sua cidade **as bases de uma economia circular Bitcoin**, similar a [Arnhem na Holanda](https://www.arnhembitcoinstad.nl/)? Se sim, vá em frente!

## Contatando a Imprensa e Rádio Locais
<chapterId>435bfbc1-22dd-59bb-b737-a32ea995b238</chapterId>

Muito frequentemente esquecido, nós, bitcoiners, geralmente pensamos que os melhores meios de comunicação são as redes sociais e a internet. Mas estamos – em parte – enganados.

Várias comunidades (este é o caso notavelmente com [Breizh Bitcoin](https://breizhbitcoin.com/), na França) têm assim o hábito de **contatar sua imprensa local** a fim de:
- **Falar com eles sobre os eventos que organizam** (meet-ups, apresentações, workshops, festas de halving, etc.);
- **Convidá-los a explorar negócios locais que aceitam Bitcoin, com o objetivo de escrever um artigo** sobre o assunto;
- mas também, simplesmente, **pedir para compartilhar a data e o local de seus próximos eventos**.

De fato, muitos jornais locais ainda têm, em sua última ou penúltima página, uma lista de eventos organizados na região.
O feedback do Breizh Bitcoin é claro: funciona bem, e novas pessoas compareceram aos seus meet-ups após descobrirem sua associação no jornal.

Embora isso possa ser específico para a localidade em que você está situado, aqui está uma lista dos principais títulos de imprensa regional francesa:
...
Paralelamente, também pode ser interessante **contatar estações de rádio locais, para propor, por exemplo, a criação de um podcast ou uma entrevista**.
No entanto, esteja ciente de que palavras na mídia podem facilmente ser usadas a seu desfavor. **Então, esta não é uma tarefa fácil, e pode ser sábio preparar-se para ela**.

![imagem](assets/fr/chapter35/58-fr.webp)
####
Obviamente, **muitos outros projetos podem ser realizados**. Em geral, tudo dependerá do seu tempo, sua motivação; mas também da dificuldade do projeto em questão.
Na realização destes, **três conselhos** podem guiá-lo:
1) **defina antecipadamente as etapas do projeto, seu(s) objetivo(s) e o que precisa ser feito**;
2) **proceda passo a passo, sem desanimar**; 3) e acima de tudo, **peça ajuda e apoio aos seus membros e outras comunidades ao seu redor**.

Tenha em mente que **cada comunidade e encontro passou pelas mesmas etapas pelas quais você está passando**. Então, não hesite em **pedir conselhos**.

# Antecipando o Futuro
<partId>6ea07445-9369-54bc-9aa0-d260db026e0b</partId>
## Planejando um Aumento nos Participantes
<chapterId>8af722d4-3a9f-548c-9001-424f2142de12</chapterId>

À medida que o mundo entrou em sua quarta época, no bloco 840.000, cada vez mais indivíduos veem o **Bitcoin como uma revolução tecnológica, financeira e social**.
Assim como a revolução da internet, esta também **levará tempo**, e isso é bom. Isso permitirá que todos **se eduquem sobre os fundamentos do Bitcoin e aprendam a usá-lo**. Mas também, dará tempo para que desenvolvedores e empresas desenvolvam protocolos e aplicações relevantes, permitindo a exploração do potencial completo do Bitcoin.
Embora seja impossível prever o futuro, **um aumento muito significativo no número de usuários do Bitcoin deve ser antecipado**, a fim de **estar preparado para todas as situações**. Incluindo as mais catastróficas, como uma possível implosão do sistema financeiro tradicional; ou até mesmo: uma proibição do Bitcoin.

Nesta oitava e última parte deste curso, vamos dedicar um tempo para detalhar alguns pontos a considerar ao desenvolver sua comunidade e seus encontros.
####
O primeiro entre eles (o mais fácil de antecipar) é obviamente **o aumento no número de pessoas ingressando em sua comunidade**. Isso impactará de duas maneiras:

1) **seus canais de comunicação (Telegram, Signal, Matrix, etc...) ficarão cheios, potencialmente tornando as conversas difíceis de seguir**. Dois pontos são então a considerar.
Por um lado, se você tem 500 trocando mensagens sobre vários tópicos no mesmo canal de discussão, a maioria dos seus membros gradativamente deixará de seguir as conversas; entre outras coisas por causa da abundância de mensagens para ler e notificações associadas. Nesse sentido, pode ser relevante **repensar seus canais de comunicação; como por exemplo supergrupos do Telegram, ou até mesmo um servidor no Discord**, que ambos permitem agrupar conversas por tema.
Por outro lado, mais pessoas nos canais de troca também significa mais bots, mais golpes, e também **mais moderação a ser feita**. Você precisará estar preparado, redigindo por exemplo um conjunto de regras nas quais você pode se basear quando moderar uma mensagem. Pela experiência, isso evita grande parte dos conflitos; especialmente quando as regras estão disponíveis para leitura em seus canais de comunicação. Nesse sentido, a associação Bitcoin Lille escreveu há alguns anos **[um conjunto de regras de código aberto](https://bitcoinlille.fr/reglement/) para seu grupo no Telegram e seu servidor no Discord**, baseado em princípios simples e universais. Seu design está [também disponível](https://www.canva.com/design/DAGHI692AD4/rjT4sqEnhajc5FiPA6GFZQ/edit?utm_content=DAGHI692AD4&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![imagem](assets/fr/chapter36/59-frbis.webp)

2) **seus encontros e eventos ficarão significativamente cheios, com uma abundância de novos rostos querendo trocar entre si**.
Diante dessa afluência significativa, várias abordagens podem ser discutidas e consideradas:
- Primeiramente, pode ser relevante **encontrar um lugar maior para organizar encontros e eventos**, especialmente se você só podia acomodar cerca de vinte pessoas no local anterior;
- Em segundo lugar, se você perceber que a presença humana se torna muito avassaladora, você também pode – para os próximos encontros – **exigir que os participantes se registrem** (isso pode ser feito via aplicativo Meetup, ou por meio de um formulário padrão), **ou organizar múltiplos encontros dentro do mês** (por exemplo: um encontro para iniciantes, um para intermediários e outro para especialistas);
- Além disso, é certo que muitos iniciantes no ecossistema se juntarão a você, geralmente com o objetivo de ganhar dinheiro. **Para que as conversas permaneçam focadas no Bitcoin durante esses encontros que crescem rapidamente**, é aconselhado:
    a) **realizar uma apresentação temática sobre Bitcoin durante esses encontros**, pois isso levará posteriormente uma boa parte dos participantes a discutir esse tema, e não um suposto novo projeto revolucionário;
    b) **não se limitar apenas aos bitcoiners, mas abordar os recém-chegados, mesmo que isso signifique tomar a iniciativa de ficar no fundo da sala para recebê-los**. As discussões podem então girar em torno das razões pelas quais essas pessoas vieram, o que estão procurando, os objetivos (ou fundamentos) da sua comunidade, etc.
####
Finalmente, embora seja lamentável dizer, **golpistas podem aparecer nos encontros**. Seu objetivo será então falar o máximo possível sobre seu esquema de pirâmide, seu MLM, ou seu "projeto revolucionário de blockchain". Também é totalmente plausível que pessoas com intenções maliciosas venham especificamente para lavar dinheiro ou comprar BTC com notas falsas.
Em situações complexas como essas, a abordagem mais simples é tomar a iniciativa de "gentilmente" explicar a esses indivíduos que o encontro não é o lugar onde eles terão sucesso, apresentando argumentos x ou y (como, informar sobre a presença de polícia disfarçada).
Se, infelizmente, esses indivíduos recusarem a sair ou a cumprir com as regras de decência (o que já aconteceu antes), um anúncio verbal durante o encontro informando que um ou mais indivíduos estão tentando se envolver em tais atos maliciosos pode ser feito.
**Felizmente, essas situações são raras e geralmente bastante peculiares. Mas é melhor estar preparado.**
Além disso, se isso pode tranquilizá-lo como organizador, contanto que você não esteja violando a lei ou facilitando trocas ilegais, você não precisa se preocupar. Na França, você de fato não é legalmente responsável pelas ações de outros.####
Em um mundo ideal, seria portanto melhor ter um local que possa acomodar várias dezenas de pessoas (dependendo do crescimento da sua comunidade); mas também, **construir relações sólidas entre bitcoiners e futuros bitcoiners durante o mercado de baixa**, para que você esteja pronto para **converter durante o próximo mercado de alta**.

## Descentralizando a Organização da Sua Comunidade
<chapterId>bedfc110-e099-58f4-a5b7-fb50f3b19a49</chapterId>

Você é o organizador de um encontro e, de um dia para o outro, **decide parar essa tarefa** para ir criar lhamas no Peru; apenas deixando tudo para trás?

**Considere passar adiante sua comunidade**:
1) **dando direitos administrativos (ou até de propriedade) dos canais de comunicação a indivíduos de confiança**, mesmo que isso signifique mudar de mãos mais tarde;
2) **compartilhando com pelo menos uma pessoa de confiança na sua comunidade os nomes de usuário, senhas e e-mails das contas e redes sociais** que você criou para dar visibilidade a ela.

Sem esses direitos e identificadores, será impossível para qualquer pessoa **assumir facilmente e assim continuar a iniciativa que você dedicou tanto tempo desenvolvendo**.
Começar do zero criando redes e canais "forkados" de fato leva tanto tempo e tanta energia…
**Portanto, antecipe sua possível partida** para o Peru. E se você não tiver, na França, um membro de confiança em seu encontro, você sempre pode contatar @ProfEduStream ou @gabtribe no Telegram para fazer essa transição de forma suave.####
Isso nos leva a **um ponto crucial no desenvolvimento de uma comunidade: sua descentralização**.
De fato, se você é a única pessoa envolvida nela, tendo todos os controles, o que acontecerá se você desaparecer? A resposta é simples: sua comunidade desaparecerá.

A melhor maneira de evitar isso é, portanto, **descentralizar tarefas e compartilhar direitos, papéis e acessos**. Assim, se um dos membros da equipe organizadora de sua comunidade ou encontro for preso em uma futura distopia porque possui Bitcoin não-KYC (ou simplesmente: porque não tem mais tempo para dedicar a isso porque acabou de ter um filho ou mudou de emprego), os outros podem continuar suas missões sem dificuldade.
####
Com o objetivo de descentralizar ainda mais, **usar softwares de código aberto como o conjunto framasoft** também pode constituir uma primeira "linha de defesa" contra um estado fictício que censuraria o Bitcoin. Usar ferramentas de comunicação criptografadas - até mesmo anônimas - é a segunda.
## E se o Bitcoin se tornasse o inimigo público número 1?
<chapterId>c739651f-cd13-51e0-a36e-85023749b15b</chapterId>

Em 5 de abril de 1933, Franklin Roosevelt, então o 32º presidente dos Estados Unidos da América, assinou a Ordem Executiva 6102, proibindo qualquer indivíduo de possuir moedas de ouro, barras de ouro e certificados de ouro em todo o território.

![image](assets/fr/chapter37/60-enbis.webp)

Obviamente, a Grande Depressão (o crash da bolsa de valores de 1929) não é mais relevante hoje. Mas quem pode dizer que, amanhã, outro estado não fará o mesmo e **proibirá qualquer indivíduo de possuir bitcoin?**
####
Felizmente, essa distopia orwelliana não impedirá ninguém de realmente possuir seus bitcoins, pois é impossível impedir alguém de aprender uma sequência de palavras.
Mas o que acontecerá **se os líderes do nosso mundo finalmente entenderem que o Bitcoin tem a capacidade de mudar a ordem mundial, incluindo no nível do estado?** O Bitcoin se tornará então **"o inimigo público número 1"?**
####
Claro, não devemos cair em uma forma de pensamento conspiratório. Mas **nada nos impede, desde já, de antecipar, descentralizar e educar**.
...
## Um plano de ação resumido para criar sua comunidade Bitcoin
<chapterId>1f463ec2-3f64-5641-8d60-e02a47c94f27</chapterId>

Satoshi Nakamoto criou uma ferramenta revolucionária que tem a capacidade de mudar o mundo como o conhecemos. No entanto, é certo que **cabe a nós, bitcoiners, escolher a trajetória que desejamos tomar para construir o futuro**.

Paralelamente, a essência do Bitcoin o torna um vasto buraco de coelho, cruzando tantos aspectos históricos, econômicos, literários, matemáticos, de ciência da computação e criptográficos que é impossível cobrir tudo. Isso constitui parte de sua beleza.
Como seres humanos, temos apenas uma quantidade finita de tempo durante nossas vidas. **É permanecendo humildes e aprendendo com os outros** que cada um de nós será capaz de alcançar os objetivos que estabelecemos para nós mesmos em entender o Bitcoin.
**As comunidades globais de Bitcoin, portanto, desempenham um papel fundamental na construção do mundo de amanhã**; comunidades nas quais os bitcoiners podem **trocar, construir e compartilhar**. **Juntos**.
####
Como você deve ter entendido deste curso, **criar uma comunidade e um encontro sobre Bitcoin** requer organização e motivação. Claro, dependendo dos seus desejos e do tempo que você tem para dedicar a isso, você irá mais ou menos longe nos projetos.
No entanto, o objetivo permanece o mesmo: **acender a faísca para o Bitcoin crescer em sua cidade**.
####
Para resumir os muitos capítulos e subcapítulos deste curso, aqui está **um "plano de ação" resumido para criar sua comunidade Bitcoin**:
1) decida antecipadamente por que você quer criar uma comunidade Bitcoin, para quais propósitos, onde, etc.;
2) aproxime-se de comunidades já estabelecidas ao seu redor fazendo contato e/ou pedindo conselhos;
3) crie uma identidade única para sua comunidade e sua localização (logo, pôster, banner, flyer, etc.)
4) crie canais de comunicação e redes sociais como Telegram, Twitter, NOSTR, Discord. Considere também canais descentralizados e/ou impossíveis de censurar;
5) aproxime-se de encontros e comunidades vizinhas (especialmente nas redes sociais) e faça com que sua comunidade seja listada em diversos mapas e plataformas para ganhar visibilidade;

Uma vez que os canais de comunicação da sua comunidade estejam suficientemente desenvolvidos:

6) proponha um tipo de encontro através de uma pesquisa;
7) pense nos objetivos que você deseja alcançar com este evento físico;
8) procure um local bem localizado e acolhedor que atenda aos seus objetivos e reserve uma mesa;
9) uma semana antes do evento, comunique sobre ele em suas redes e canais de comunicação. Repita isso dois a três dias antes da data crucial;
10) faça com que seu evento seja listado em plataformas e sites adequados, se possível;
11) no dia do encontro, deixe as coisas acontecerem e vá ao encontro dos outros, mesmo que isso signifique direcionar gentilmente a conversa de volta, se necessário;

Dando seguimento:

12) busque reter e envolver o máximo de membros e participantes possível para que eles retornem;
13) Proponha ideias de projetos e iniciativas simples, e comece a implementar aquelas que são pessoalmente importantes para você. Se alguém quiser montar algo diferente, não hesite em dar uma mão com base na tarefa e no objetivo desejado;
Finalmente:

14) Antecipe o futuro considerando um local maior para encontros, regras para canais de comunicação, um site, etc.;
15) Comece a democratizar a aceitação do Bitcoin nos negócios da sua cidade, perguntando se eles aceitam Bitcoin, por exemplo;
16) Descentralize tarefas entre indivíduos confiáveis, bem como os direitos aos seus canais e redes;
17) Promova sua comunidade para que mais e mais pessoas se juntem e envolva indivíduos interessados;
18) Vá ainda mais longe com projetos que você gosta e se importa.

De uma maneira um pouco menos detalhada, em um vídeo de 21 minutos, parece assim:
<videoId>56e302c2-b42c-4a4e-88fc-af207232f5ae</videoId>
####
De qualquer forma, **lembre-se de que você não está sozinho e que as comunidades existentes estão lá para ajudá-lo**.

## Curso BTC302
<chapterId>8bf10b77-80ee-5d50-87bc-0ef32574a675</chapterId>

Neste curso BTC302, detalhamos as etapas para criar uma comunidade, um encontro; mas também, a implementação de numerosos projetos.

Quando sua comunidade se sentir pronta para avançar para o próximo nível, **é possível criar uma associação**.
Na França, por exemplo, de cerca de cinquenta comunidades e encontros, existem quase dez associações.
####
O interesse em criar uma é duplo:
- por um lado, o status de uma associação permite **ter um status oficial, abrir uma conta bancária associativa e também obter uma forma de reconhecimento por parte da imprensa, mídia e subsídios**; - por outro lado, possibilita **uma organização mais precisa das operações da comunidade e a implementação de seus projetos**, definindo papéis específicos.
####
Com o objetivo de fazer sua comunidade prosperar ainda mais, **um curso chamado COMMU201 será lançado em [planb.network](https://planb.network/) nos próximos meses**.

Por meio dele, **também detalharemos outro ponto importante: a organização de eventos em grande escala, com cerca de uma centena de participantes**. Abordaremos questões como: Por quê? Que organização? Onde? Que orçamento? Como? Que operação?
Para alcançar isso, começaremos com a experiência de várias comunidades francesas que já organizaram seus próprios eventos, como **o BEF (Bitcoin Economic Forum, em maio, na Bretanha) e o B-only (em novembro, em Annecy)**.

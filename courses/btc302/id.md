...
2. **Pilih nama untuk komunitas/pertemuan Anda yang merujuk ke kota ini**, membuatnya mudah bagi orang untuk mengidentifikasi diri dengan itu. Misalnya: "Bitcoin Paris", "Einundzwanzig Berlin", "Satoshi Spritz Milano", dll.
...
Dalam hal ini, **menetapkan tujuan dan proyek konkret tampaknya perlu**.
...
Inilah alasan mengapa **kursus ini dibuat dengan tujuan berbagi semua sumber daya dan tips yang mungkin agar komunitas Anda dapat tumbuh dan menjadi mandiri**.
...
Untuk memberi Anda beberapa ide, berikut adalah beberapa contoh logo dari komunitas Prancis:
...
Singkatnya, **kemungkinannya tidak terbatas dan tergantung pada kebutuhan Anda tetapi juga pada piagam grafis yang ingin Anda ciptakan** untuk komunitas dan pertemuan/acara Anda!
...
![gambar](assets/fr/12.webp)
![gambar](assets/fr/13.webp)
...
Namun, saat membuat visual Anda, pastikan untuk memperhatikan dimensi yang diharapkan oleh jaringan sosial dan aplikasi komunikasi yang Anda rencanakan untuk digunakan.
...
Ini hanya **sebuah grup Telegram di mana beberapa "topik" diintegrasikan**. Dengan demikian, topik **"Informasi Penting"** dapat dibuat, di mana hanya informasi penting dan informasi yang terkait dengan acara/pertemuan mendatang yang akan diposting.
...
Seperti yang disebutkan sebelumnya dalam bagian ini, Twitter dan Telegram adalah dua saluran komunikasi utama yang digunakan di Eropa (dan mungkin di dunia).
...
Setelah Anda merasakan percikan kecil ini, maka sepenuhnya mungkin bagi Anda untuk mengusulkan ide pertemuan langsung. Jika ide ini menarik minat orang lain, Anda hanya perlu **menetapkan tanggal untuk meet-up pertama Anda**.
...
Setelah Anda kembali ke rumah, sangat mungkin Anda akan memiliki **bitcoin di mata Anda** selama beberapa hari. Ini akan menjadi momen yang tepat untuk menilai umpan balik, misalnya dengan:
...
Jelas, setiap peserta memiliki kepribadian, sensitivitas, tujuan, dan minat mereka sendiri. Oleh karena itu, masing-masing akan mengalami pertemuan itu secara berbeda.
...
## Mengorganisir pertemuan tematik, mengikuti progresi tahunan yang ditentukan
...
- jika Anda ingin stiker ini dapat ditempel di luar ruangan, Anda memerlukan **stiker tahan air** ("waterproof" atau tidak tembus air);
...
Juga, sebuah catatan kecil: **jika Anda memutuskan untuk menempelkan salah satu stiker ini di jalan, tergantung pada negara tempat Anda berada, hal ini mungkin dilarang oleh hukum**. Dalam kasus Prancis, misalnya, dilarang menempelkan stiker di jalan, kecuali pada papan iklan umum yang ada di setiap kota. Ini berarti jika salah satu stiker Anda ditempelkan secara sembarangan (atau lebih tepatnya: di mana saja, seperti di tengah-tengah rambu stop), itu akan segera dihapus; dan jika itu memiliki informasi yang dapat dilacak kembali ke identitas Anda atau pertemuan Anda, bukan tidak mungkin Anda bisa menerima denda. Jadi, berhati-hatilah dan informasikan kepada anggota Anda.

####

Secara paralel, jika Anda menyukai konser, bar, atau stadion, **pertimbangkan untuk memeriksa apakah sudah ada stiker yang ditempel sebelum menempatkan milik Anda. Jika tidak, pertimbangkan untuk bertanya kepada seorang karyawan apakah ini diterima**.
Memang, akan sangat disayangkan jika seorang pedagang mendengar tentang komunitas / pertemuan / asosiasi / Bitcoin Anda untuk pertama kalinya karena Anda merusak dekorasi toiletnya!

## Membuat Perpustakaan

<chapterId>acc94093-f8b3-51b8-9359-348e9e075d38</chapterId>

Proyek lain yang dapat dengan mudah diimplementasikan adalah **pendirian perpustakaan dalam pertemuan Anda**.
Untuk melakukan ini, Anda dapat meminta semua orang yang tertarik untuk berbagi bacaan mereka dengan membawa buku terkait Bitcoin dan, selama pertemuan, jika ada orang lain yang tertarik untuk meminjamnya, **pinjaman dapat misalnya dibuat kepada pemiliknya, sebagai imbalan atas deposit 21.000 satoshi di Lightning**.
Ini memungkinkan, bagi pemilik, untuk menutupi biaya dalam kasus kelalaian atau pencurian; dan, bagi peminjam, untuk kembali ke pertemuan mendatang untuk mengambil kembali 21.000 satoshi mereka!

####

Jika Anda menjalankan **sebuah asosiasi dan ingin menginvestasikan sebagian dari kas Anda dalam sumber daya edukatif dan pedagogis**, Anda dapat memesan beberapa buku dan menawarkannya di **perpustakaan Bitcoin** Anda di setiap pertemuan.
![image](assets/fr/39.webp)

####

Dalam hal ini, dan dengan tujuan mengembangkan ekosistem, **[penerbit Konsensus.Network](https://konsensus.network/) menawarkan diskon mulai dari 15% hingga 35% pada semua bukunya kepada pertemuan dan komunitas Bitcoin internasional; dimulai dari tiga buku yang dibeli**.

Jika Anda tidak memiliki kas, masih mungkin bagi anggota komunitas Anda untuk mendapatkan diskon ini.
Memang, salah satu penyelenggara komunitas Anda dapat, misalnya, mengkoordinasikan pesanan beberapa anggota dan menempatkannya dengan Konsensus untuk biaya yang lebih rendah, dengan tujuan mendistribusikan kembali salinan yang diterima di pertemuan berikutnya. Redistribusi ini kemudian, misalnya, dapat dilakukan di Lightning.

Untuk memanfaatkan diskon ini, cukup **hubungi [rumah penerbit Konsensus](https://twitter.com/KonsensusFR) di Twitter**.

####

Selanjutnya, sebuah piagam peminjaman buku dapat ditulis dan ditampilkan selama pertemuan, menjelaskan secara singkat aturan peminjaman.

Berikut adalah contoh sumber terbuka, yang dapat Anda ambil dan modifikasi sesuai keinginan Anda:
...
Secara paralel, masih dengan ide untuk mempromosikan membaca tentang Bitcoin, tindakan signifikan lainnya dapat menjadi **mengunjungi perpustakaan kota dan memeriksa apakah mereka memiliki berbagai buku tentang Bitcoin**.
Jika iya, mungkin bisa ditanyakan kepada pustakawan apakah **meja bundar** mengenai topik ini akan diadakan dalam beberapa bulan mendatang, bahkan memberikan mereka kontak dari pertemuan komunitas kota. Jika tidak, **mengusulkan pembelian beberapa buku yang telah Anda pilih sebelumnya** bisa menjadi sebuah opsi. Situs web [Penerbit Konsensus](https://konsensus.network/) bisa menjadi sumber inspirasi untuk ini.

## Buat flyer khusus, dan sebarkan

<chapterId>62ad5430-c698-51b3-89ac-090f31c88953</chapterId>

Membuat flyer adalah langkah yang memakan waktu. Namun, hal ini memungkinkan untuk **memiliki dukungan kertas selama diskusi tentang Bitcoin**, yang cukup berharga.

Flyer ini bisa ditujukan untuk:

- **para pedagang**, jika Anda ingin mengusulkan kepada mereka penerimaan Bitcoin sebagai metode pembayaran;
- **orang-orang yang menghadiri acara Anda**, dengan flyer yang secara khusus menjelaskan cara menggunakan dan membayar dengan Bitcoin / Lightning; - dan **pendatang baru**, yang ditemui di jalan, di tempat kerja, atau dalam makan malam keluarga, dengan flyer yang merangkum manfaat utama dari Bitcoin.

Juga sepenuhnya mungkin untuk menyiapkan **flyer khusus untuk komunitas atau pertemuan Anda, yang menampilkan aksi-aksi Anda, tujuan-tujuan Anda, jaringan dan saluran komunikasi Anda; tetapi juga, tanggal dan lokasi dari acara yang sudah direncanakan**.

####

Beberapa flyer sudah **tersedia secara open-source**, dan lainnya akan dibuat dalam beberapa bulan mendatang. Anda bisa menemukannya khususnya **di [Bitcoin Educational Toolkit oleh planB.network](https://planb.network/fr/resources/bet)**.

Di antaranya, Anda akan menemukan [flyer bersumber lengkap](https://profedustream.substack.com/p/21-raisons-dutiliser-bitcoin) yang mencantumkan 21 alasan untuk menggunakan Bitcoin. Desainnya juga [tersedia secara open-source](https://www.canva.com/design/DAFtAR1NauQ/ZDwl2CchIJ9Gpb36N6-7iw/edit?utm_content=DAFtAR1NauQ&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![image](assets/fr/41.webp)
![image](assets/fr/42.webp)

Modifikasi, sesuaikan, dan kemudian bagikan sesuka Anda. Namun, ingat untuk menyebutkan sumber Anda.

####

Seperti disebutkan sebelumnya, **flyer ini bisa ditempatkan hampir di mana saja**: di meja bersama di tempat kerja Anda, di meja selama makan malam keluarga, di perpustakaan kota, dll.

Di Prancis dan di beberapa negara lain, juga ada **"kotak buku"**.
Biasanya terbuat dari kayu, kotak-kotak ini dengan bebas menyambut buku untuk diberikan. Oleh karena itu, salah satu kemungkinan adalah untuk **meninggalkan flyer di sana; atau bahkan lebih baik: sebuah buku!**

![image](assets/fr/chapter27/43.webp)
![image](assets/fr/43.webp)

Dalam hal ini, pada tahun 2023, **inisiatif "Sebuah Kertas Putih Bitcoin di Kotak Buku Prancis"** diluncurkan.
Untuk melaksanakan proyek ini dengan sukses bersama semua pihak yang tertarik, pertama-tama diperlukan untuk **mendapatkan geolokasi semua kotak buku yang ada di negara tersebut**. Untuk melakukan ini, berbagai basis data ada:
...
- [delivrez.fr](https://delivrez.fr/maps/fr_FR/); serta beberapa artikel di pers lokal.
  Tentu saja, menempatkan makalah putih Bitcoin di pertukaran buku ini memiliki makna simbolis. Namun, bagi pemula, ini terlalu kompleks untuk dipahami. Oleh karena itu, ide tersebut adalah untuk **menulis sebuah buklet kecil, termasuk**:
- **pengenalan yang disederhanakan dan bersumber tentang Bitcoin, penggunaannya, dan masalah yang dipecahkannya**;
- dan **makalah putih Bitcoin**, diterjemahkan ke dalam bahasa Prancis.

Berikut adalah buklet yang telah dibagikan di antara bitcoiner Prancis [buklet yang telah dibagikan di antara bitcoiner Prancis](https://profedustream.substack.com/p/bitcoin-la-naissance-dune-nouvelle) dan yang berakhir perjalanannya di beberapa lusin pertukaran buku di seluruh negeri. Desainnya juga [tersedia dalam sumber terbuka](https://www.canva.com/design/DAFs18FSoVM/Sy0QsfUkycTgXveeGgutBg/edit?utm_content=DAFs18FSoVM&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![gambar](assets/fr/44.webp)
![gambar](assets/fr/45.webp)

## Mengorganisir Pemutaran Video

<chapterId>892b248a-b837-5df6-aac9-4b3261ff0390</chapterId>

Setiap bitcoiner pasti sudah pernah melihat mini-seri yang sangat menarik "The Satoshi Mystery, at the Origins of Bitcoin" oleh [Rémi Forte](https:/https://twitter.com/forteremi).
Dirilis pada tahun 2021, telah ditonton [beberapa juta kali di YouTube](https://www.youtube.com/watch?v=0ETcLj5jBy4), karena ini merupakan langkah pertama yang merangsang untuk memahami dari mana asal Bitcoin.
Dalam hal ini, sepenuhnya mungkin untuk **mengusulkan pemutaran video mini-seri ini kepada komunitas Anda**; bahkan menciptakan acara khusus misalnya.

Namun, ada satu masalah kecil: di Prancis, kami menghubungi ARTE untuk memverifikasi apakah ini secara hukum mungkin. Sayangnya, karena **hak pemutaran**, biaya per pemutaran hampir 250€; dengan diskon yang mungkin sebesar 120€ per pemutaran jika 5 pertemuan dilakukan dalam setahun.
Akibatnya, bagi sebagian besar komunitas, tarif ini terlalu mahal. Namun, dokumenter tersebut tersedia gratis di ARTE...

####

Secara paralel, pemutaran lain dapat diorganisir.
Di Prancis, misalnya, **sutradara dokumenter "Stranded", [Alana Mediavilla](https://twitter.com/AlanaMediavilla), setuju untuk membiarkan pertemuan di negara tersebut memutar dokumenternya dalam pratinjau**; beberapa cuplikan berasal dari sekuen [film "Dirty Coin"](https://www.dirtycointhemovie.com/) yang akan dirilis pada tahun 2024.
Komunitas Bitcoiner Prancis kemudian mengambil inisiatif untuk **menerjemahkan penuh dokumenter "Stranded"**, mengintegrasikan subtitle bahasa Prancis, dan membagikannya dengan semua pertemuan di seluruh negeri. Selama minggu 4 Maret 2024, **pemutaran bersama diorganisir di sekitar sepuluh pertemuan di seluruh negeri**.
![gambar](assets/fr/46.webp)

Penayangan ini mengarah pada banyak diskusi tentang penambangan Bitcoin, konsumsi listriknya, dan dampaknya terhadap ekologi secara lebih luas.

## Memasang Poster di Kota Anda

<chapterId>6565e8a0-d535-5be0-9764-273584c675bd</chapterId>
Di beberapa negara Eropa (Jerman, Spanyol, Prancis, dll.), **beberapa penggemar Bitcoin telah mengambil inisiatif untuk memasang poster yang berkaitan dengan Bitcoin**. Beberapa poster ini kemudian menampilkan karya-karya dari Banksy, sementara yang lain menggabungkan logo Bitcoin dengan berbagai cara.
Hal ini terutama terjadi pada [StreetCyberArt](https://twitter.com/streetcyber_art), seorang penggemar Bitcoin asal Jerman, yang telah menciptakan kolase dan seni jalanan selama beberapa tahun.

![image](assets/fr/47.webp)

####

Tentu saja, jika Anda ingin terlibat dalam pemasangan poster di jalanan, akan sangat penting untuk **mengetahui hukum di negara Anda**. Di Prancis, misalnya, hanya diperbolehkan untuk **memasang poster di papan reklame publik**. Di tempat lain, hal ini dilarang dan dapat mengakibatkan denda.
Jelas: **mata yang tidak melihat, hati yang tidak gundah**. Jadi, dalam kasus ini, mungkin berhati-hatilah untuk tidak menyertakan elemen apa pun pada poster tersebut yang bisa dilacak kembali ke Anda (nama pertemuan, @ Twitter, dll.)

Jika Anda berencana untuk **mencetak jenis poster ini dengan printer pribadi, sadarilah bahwa ini umumnya menyebabkan kertas cepat luntur, tetapi juga cepat rusak seiring waktu**. Dalam hal ini, **hal terbaik yang dapat dilakukan adalah tentu saja menghubungi percetakan profesional untuk memproduksi poster ini pada kertas khusus yang dirancang untuk penggunaan luar ruang**. Dengan demikian, kualitas akan terjamin.

![image](assets/fr/48.webp)

####

Namun, tidak dapat dipungkiri bahwa **inisiatif ini memiliki biaya yang signifikan: lebih dari 0,40€ per poster (yaitu, 40€ untuk seratus poster)**; dan itu, ketika Anda memiliki kontak yang baik. Secara online, harga memang bisa bervariasi dari dua kali lipat hingga lima kali lipat lebih banyak.

Seperti disebutkan sebelumnya, penggemar Bitcoin Prancis [@Mill3sim3](https://twitter.com/Mill3sim3) memiliki peralatan profesional yang sesuai. Oleh karena itu, Anda dapat menghubunginya di Twitter untuk informasi.

## Memiliki Kartu NFC Kustom

<chapterId>8ad65d4e-a68a-59c2-a812-85f4907ed9f3</chapterId>
Proyek unik lainnya adalah **pembuatan kartu NFC kustom untuk pembayaran menggunakan Lightning**, mengikuti standar BoltCard. Untuk tujuan ini, **Swiss Bitcoin Pay** adalah mitra berkualitas.

Saat ini, di situs web mereka di [https://swiss-bitcoin-pay.ch/cards](https://swiss-bitcoin-pay.ch/cards), Swiss Bitcoin Pay menawarkan empat desain dasar.
Namun, jika Anda ingin memesan **lebih dari 50 kartu NFC, Anda dapat menghubungi perusahaan melalui situs web resminya (atau di [Twitter](https://twitter.com/SwissBitcoinPay)) dan mengusulkan desain kustom yang Anda buat untuk bagian depan kartu**. Bagian belakang, bagaimanapun, distandarisasi.

![image](assets/fr/49.webp)

[Asosiasi Bitcoin Prancis Lille](https://twitter.com/BitcoinLille) misalnya, memesan seratus kartu NFC dengan desain kustom pada tahun 2023, dengan **harga sekitar 2,50€ hingga 5€ per kartu** (tarif berubah secara reguler dan progresif).
Dengan demikian, **setiap anggota baru asosiasi menerima kartu NFC kustom dalam paket sambutan mereka**.

Ide ini jelas dapat diambil dan ditingkatkan sesuai keinginan Anda.

## Membuat Situs Web

<chapterId>9a2a1b9b-0633-544a-b331-c06187d23d7f</chapterId>
Dengan tujuan memiliki sebuah etalase untuk komunitas Anda, pertemuan, acara, dan dokumen pendidikan, mungkin relevan pada suatu titik untuk **memiliki sebuah website**. Namun, **membutuhkan banyak waktu untuk mendesain** (beberapa puluh jam).
...
CMS atau platform lain juga memungkinkan pembuatan website. Meskipun beberapa lebih sederhana karena antarmuka yang ramah pengguna, website yang dihasilkan juga jauh kurang dapat disesuaikan.
**WordPress tampaknya menjadi pilihan paling relevan untuk memulai**. Selain itu, memungkinkan **integrasi plug-in**, beberapa di antaranya berbayar tetapi berkualitas tinggi, memungkinkan pengembangan website lebih lanjut; dan ini, tanpa perlu mengkode.
[Uncode plugin](https://undsgn.com/uncode/), yang berbayar, adalah salah satunya.

## Membuat Saluran Video (YouTube atau Odyssee)

<chapterId>076286db-1627-57ec-a410-c44b1666e1cd</chapterId>

Di antara anggota komunitas Anda, beberapa mungkin tertarik dalam **menciptakan konten multimedia**. Ini bisa, misalnya, berupa produksi video tutorial (menggunakan dompet software, tutorial untuk membeli BTC non-KYC, dll.)
Secara paralel, mungkin akan ada hari ketika presentasi dibuat di pertemuan Anda. Atau bahkan, ketika komunitas Anda mengadakan konferensi di sekolah pasca-menengah dan universitas.

Dalam hal ini, **ketika kebutuhan muncul, mungkin relevan untuk memiliki saluran video yang memungkinkan Anda memposting online semua video, presentasi, dan konferensi yang dibuat sebagai bagian dari aksi dan proyek Anda**.

####

Di antara platform video yang paling terkenal, kita khususnya menemukan:

- [**YouTube**](https://www.youtube.com/), yang memiliki kelemahan **tidak tahan terhadap sensor**;
- [**Odyssee**](https://odysee.com/), yang relatif kurang digunakan tetapi adalah **desentralisasi** melalui operasinya peer-to-peer;
- [**peertube**](https://joinpeertube.org/fr_FR), memungkinkan Anda untuk membuat platform video Anda sendiri. Ini mungkin langkah di atas dalam hal pengaturan.

Tergantung pada apa yang Anda putuskan untuk diterapkan, Anda jelas akan perlu **menciptakan visual khusus untuk platform ini**, dengan tujuan membuat saluran video Anda secara visual menarik. Poin positifnya adalah dengan **Canva**, yang kami bahas di [bagian 2/8 dari kursus ini](LINK), ada kategori "Thumbnail YouTube" dengan visual yang sudah dirancang dan mudah dimodifikasi.

![image](assets/fr/50.webp)

####

Dalam kasus di mana Anda ingin **merekan di komputer Anda, software seperti ["Streamlabs"](https://streamlabs.com/fr-fr) bekerja sangat baik**. Ini memungkinkan Anda untuk menyesuaikan banyak pengaturan, gratis, dan juga memungkinkan transisi scene.

Untuk **pengeditan video** (jika ada), Anda akan perlu memiliki software yang sesuai.
Jika Anda belum memiliki satu, perangkat lunak ["Wondershare Filmora"](https://filmora.wondershare.fr/) sangat efektif dan sangat mudah digunakan; memungkinkan Anda untuk melakukan pengeditan yang serius. Sayangnya, ini berbayar (€45 per tahun). Akhirnya, untuk **intro dan outro** video Anda, pencarian spesifik di **Canva** akan memungkinkan Anda untuk menemukan apa yang Anda cari, memodifikasi hasil sesuai keinginan, mengunduhnya; dan kemudian yang harus Anda lakukan hanyalah mengintegrasikannya ke dalam perangkat lunak pengeditan Anda.
Catatan: dalam kejadian suatu hari, Bitcoin dilarang atau disensor, mungkin relevan untuk selalu **menyimpan salinan lokal pada hard drive dari video** yang Anda unggah.

## Membuat podcast audio

<chapterId>12e96b45-1c33-5687-a753-80d0114d487a</chapterId>

Membuat podcast audio juga bisa menjadi inisiatif yang menarik. Seperti halnya membuat saluran video, namun, jangan berharap untuk mendapatkan ribuan tayangan dengan cepat.

Di antara platform podcast yang paling dikenal, kita temukan:

- [**Fountain**](https://www.fountain.fm/), yang sangat menarik karena memungkinkan donasi langsung dalam Lightning;
- [**Soundcloud**](https://soundcloud.com/);
- [**Deezer**](https://www.deezer.com/fr/);
- [**Spotify**](https://open.spotify.com/);
- [**Google podcast**](https://podcasts.google.com/).

Masalahnya, bagaimanapun, adalah bahwa **masing-masing platform ini memiliki audiens yang sangat spesifik**. Jadi, untuk menjangkau sebanyak mungkin orang, Anda perlu hadir di hampir semua dari mereka.

Untungnya, platform **["Spotify for podcasters"](https://podcasters.spotify.com/) memungkinkan Anda untuk mengimpor file podcast Anda sekali, dan kemudian menghasilkan feed RSS yang dapat disalin dan ditempelkan ke platform yang disebutkan sebelumnya**.
Jadi, setelah pekerjaan selesai di "Spotify for podcasters", yang tersisa hanyalah pemformatan di platform lain Anda; yang relatif cepat.
...
## Membuat lencana untuk acara Anda

<chapterId>0cccef8d-a765-5844-8921-c40f0ce653e4</chapterId>

Selama pertemuan dan acara Anda, mungkin untuk merancang insentif kecil untuk menghadiri. Ide kemudian adalah untuk **menciptakan jenis lencana yang hanya bisa diperoleh di acara yang bersangkutan**. Ini ada di bawah nama "POAP" ("Proof Of Attendance Protocol") di blockchain lain. Namun, saat ini, tidak ada cara gratis untuk mengatur ini di Bitcoin.
Secara prinsip, inisiatif ini juga bisa berfungsi untuk **memberi penghargaan kepada anggota komunitas yang paling terlibat, misalnya dengan mengadakan undian tahunan**, di mana sebuah lencana yang diperoleh akan sesuai dengan satu tiket undian. Seorang anggota yang hadir di semua 12 pertemuan tahunan tersebut akan memiliki 12 tiket untuk undian tahunan ini.

Selain itu, dalam konteks yang sepenuhnya berbeda, juga dimungkinkan **di setiap acara untuk meminta peserta menuliskan nama depan atau pseudonim mereka pada sebuah lencana**. Alasan kehadiran mereka juga bisa ditambahkan. Strategi ini, meskipun sedikit formal, dapat memungkinkan beberapa anggota untuk **lebih mudah menemukan kesamaan dan topik pembicaraan**, sekaligus membuatnya **lebih mudah bagi pendatang baru untuk mengidentifikasi para penyelenggara** dan calon anggota asosiasi.

Beberapa model yang digunakan oleh asosiasi Bitcoin Lille juga [tersedia secara open-source di Canva](https://www.canva.com/design/DAGHAsT15MU/AIA7-L_xBjNdsuxdD4-h-Q/edit?utm_content=DAGHAsT15MU&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![image](assets/fr/51.webp)

## Merenungkan Transisi dalam Peristiwa Kematian

<chapterId>c5febf18-235c-51bc-8fbb-9467dabe4cb0</chapterId>

Poin lain yang sepenuhnya berbeda adalah sikap terhadap **kematian anggota komunitas Bitcoin Anda**.
Memang, mungkin suatu hari nanti keluarga salah satu anggota Anda yang telah meninggal menghubungi Anda untuk mengumumkan bahwa orang tersebut telah meninggal. Mereka kemudian akan menjelaskan bahwa **individu ini meninggalkan instruksi**, dan salah satunya adalah untuk **menghubungi komunitas / pertemuan / asosiasi Anda**.
Orang ini mungkin akan menjelaskan bahwa mereka **membutuhkan bantuan dalam memulihkan dana**, karena mereka adalah penerima warisan dari anggota yang telah meninggal tersebut.

Menanggapi permintaan ini, sangat relevan untuk **sudah memikirkan tentang semacam prosedur yang harus diikuti**; dan ini, untuk beberapa alasan.
Di satu sisi:

- untuk memastikan bahwa almarhum telah memikirkan untuk **menginformasikan keluarganya agar tidak pernah mengungkapkan atau membawa ke pertemuan kunci pribadi dan dompet fisik almarhum**;
- agar keluarga dengan jelas memahami bahwa **kehadiran mereka adalah untuk belajar tentang Bitcoin**, agar pada akhirnya mereka dapat menjadi berdaulat atas dana almarhum;
- agar **keluarga menyadari hukum yang berlaku di negara tersebut dalam kasus donasi, warisan, atau konversi ke mata uang fiat**;

Selain itu, memikirkan terlebih dahulu tentang prosedur yang harus diikuti juga memastikan bahwa tidak ada orang, baik anggota pertemuan atau hanya tamu, yang dapat menggunakan situasi ini dengan cara apa pun untuk keuntungan mereka (dan/atau untuk mencuri dana).

Menuju tujuan ini, mungkin menarik untuk **mengusulkan "kelompok kerja" tentang prosedur yang harus diadopsi dalam kasus kematian dan permintaan bantuan yang datang dari keluarga**. Asosiasi Bitcoin Lille sebenarnya sedang mengerjakan poin ini, dan akan membagikan dokumen kerja finalnya secara open-source [di sini](https://docs.google.com/document/d/1TDfLZjuictC5s3PEM2Z7WmkxIDSJ8Q1E4xevm52pVgU/edit?usp=sharing) dalam beberapa bulan.

## Melakukan konferensi di sekolah dan universitas

<chapterId>65efdb44-e3d4-567c-aedf-972765753d73</chapterId>
Daftar proyek yang sebelumnya dijelaskan jelas tidak lengkap. Pada umumnya, ini adalah proyek-proyek internal komunitas/pertemuan, dan bisa cukup mudah diselenggarakan setelah komunitas Anda berkembang. Oleh karena itu, sekarang saatnya untuk membahas kasus onboarding.

Pertama-tama, Anda pasti sudah sadar bahwa **salah satu cara terbaik untuk berbicara tentang Bitcoin kepada sebanyak mungkin orang dalam waktu yang sama adalah dengan mengadakan konferensi** (atau workshop). Ini dapat dilakukan **di dalam sekolah pasca-menengah dan universitas**; sehingga memimpin orang muda (dan mungkin tidak terlalu muda) untuk menemukan atau memperdalam pemahaman mereka tentang Bitcoin.

Selain pentingnya **mengetahui cara berbicara di depan umum**, menyelenggarakan konferensi di depan beberapa lusin atau bahkan ratusan orang memerlukan **kemampuan mengelola stres, artikulasi, dan waktu**. Ini juga memerlukan **persiapan presentasi atau workshop berkualitas, bersumber dan sesuai dengan tingkat keahlian audiens** yang akan Anda hadapi.
Selanjutnya, **memiliki pola pikir terbuka, siap menyederhanakan konsep jika diperlukan**, sangat penting dalam jenis latihan ini; terutama selama fase tanya/jawab dan dalam kasus diskusi panel. Ini tidak berarti "meninggalkan prinsip Anda"; tetapi hanya menerima bahwa orang lain mungkin memiliki sudut pandang yang berbeda, meskipun itu berarti merespon nanti atau membiarkannya agar dialog dapat berlanjut. Bagaimanapun, jika **pidato Anda dan jawaban Anda didasarkan pada argumen yang relevan dan bersumber**, audiens tidak akan tertipu.
Jadi, jika Anda merasa mampu: lakukanlah! Dunia kita sangat membutuhkan pendidikan tentang apa itu Bitcoin...
Namun, sudah jelas bahwa untuk menyelesaikan tugas ini, **Anda akan membutuhkan banyak motivasi, banyak pekerjaan; tetapi juga, kontak yang tepat**.

![image](assets/fr/52.webp)

####

Memang, **mengorganisir konferensi atau workshop di sekolah dan/atau universitas bukanlah hal yang mudah**.
Pertama-tama, perlu untuk **mendapatkan kontak**. Ini dapat dicapai **melalui kenalan, melalui BDE ("Bureaux Des Étudiants" atau Kantor Mahasiswa); atau bahkan asosiasi mahasiswa**, yang umumnya mengorganisir siklus konferensi dan pertemuan setiap tahun. **Profesor sekolah teknik dan/atau universitas Anda sebelumnya** juga dapat bertindak sebagai perantara.
Dalam kasus sekolah pasca-baccalaureate, juga mungkin untuk **langsung menghubungi orang yang bertanggung jawab atas program pelatihan**, dengan tujuan menjelaskan proposal Anda. Ini kemudian dapat mengarah pada pertemuan awal dan – dalam dunia yang terbaik, beberapa minggu kemudian – ke presentasi tentang apa itu Bitcoin dan bagaimana cara kerjanya di depan para siswa.

####

Sayangnya, di dunia kita saat ini, Bitcoin masih terlalu sering sengaja didemonisasikan oleh media dan politisi; membuat banyak pemula berpikir bahwa itu harus dilarang dari ruang kelas dan aula kuliah. **Kemungkinannya oleh karena itu cukup tinggi bahwa Anda akan menghadapi banyak penolakan**; terutama dalam lingkup akademis di mana bukti kerja Bitcoin dan konsumsi energinya terkadang tampak tabu.
Namun, tidak ada yang menghalangi Anda untuk mencoba, terutama dengan BDE dan asosiasi mahasiswa. **Dengan sedikit keberuntungan, meskipun penolakan itu tegas pada awalnya, tidak mustahil bahwa Anda akan dihubungi lagi selama bull-run berikutnya pada alamat email komunitas Anda untuk mengadakan konferensi di depan hampir 280 siswa!**
...
Mencapai tujuan agar **Bitcoin diterima sebagai metode pembayaran oleh pedagang** adalah semacam "cawan suci" bagi banyak penggemar Bitcoin. Ini seperti membuka pencapaian dalam Pokédex mereka! Namun, karena setiap pedagang berbeda, tugas ini tidak mudah; dan berbagai masalah muncul:

- **seorang pedagang masih memerlukan mata uang fiat untuk membayar pemasok mereka (untuk saat ini)**;
- **mereka memerlukan laporan keuangan yang jelas dan eksplisit** yang dapat dikirimkan kepada akuntan mereka;
- **metode pembayaran mereka harus bekerja tanpa masalah teknis atau logistik apa pun**, dan karyawan harus dapat menerima pembayaran tanpa bisa kabur dengan kasir.

Untuk masalah-masalah ini, tambahkan:

- **praduga potensial** pedagang terhadap Bitcoin;
- **kesulitan menemukan solusi perangkat lunak** yang bekerja dengan sempurna;
...
Mengembangkan ekosistem Bitcoin di kota Anda dapat melibatkan **mengajak pedagang bergabung**. Untuk melakukan ini, cara termudah adalah **melakukan secara bertahap**:

1. segera setelah Anda masuk ke toko, **selalu tanyakan apakah Anda dapat membayar dengan Bitcoin**. Ini umumnya akan menghasilkan penolakan dan pandangan bertanya-tanya, tetapi pertanyaan sederhana ini secara bertahap akan membuat pedagang melihat bahwa Bitcoin dapat digunakan oleh "orang normal" dan bahwa itu mendapatkan minat sebagai metode pembayaran di antara populasi. Anda bahkan dapat **mengganti dua atau tiga orang di toko yang sama, beberapa hari terpisah, bertanya untuk membayar dengan Bitcoin**. Pada suatu titik, ini akan menarik perhatian pedagang;

2. setelah mereka menjadi tertarik atau bertanya apa itu Bitcoin, Anda dapat **menjelaskannya kepada mereka secara singkat dan dengan istilah awam**. Misalnya, bahwa Bitcoin adalah mata uang, tidak dikontrol oleh bank, tanpa perantara yang dipercaya, bahwa itu tidak dapat disensor, tidak tunduk pada inflasi, dan bahwa biayanya lebih rendah daripada dengan sistem perbankan tradisional. Anda kemudian dapat **memberi mereka sebuah selebaran**, misalnya, "21 alasan untuk menggunakan Bitcoin" dan/atau "10 alasan untuk menerima Bitcoin di toko Anda", dan kemudian **memberikan kontak Anda atau kontak dari pertemuan Anda**. Dengan demikian, ketika mereka tertarik dengan demonstrasi, mereka dapat menghubungi Anda.

3. setelah orang ini memutuskan untuk menerima Bitcoin, **menyelenggarakan pertemuan dengan mereka untuk menunjukkan solusi perangkat lunak yang Anda usulkan tampaknya tepat**. **[Swiss Bitcoin Pay](https://swiss-bitcoin-pay.ch/)** menawarkan diri sebagai solusi yang sangat baik dalam hal ini, karena:

- ini memungkinkan pedagang yang ingin mengonversi pendapatan bitcoin harian mereka menjadi mata uang fiat, sehingga memungkinkan mereka untuk membayar pemasok mereka;
- ini juga memungkinkan, jika diinginkan, untuk menyimpan persentase tertentu dari pendapatan dalam BTC;
- ini memungkinkan ekspor akuntansi untuk semua pembayaran bitcoin agar dapat dikirim ke akuntan, sehingga memudahkan pekerjaan mereka;
- ini memiliki dasbor yang ramah pengguna untuk manajer;
- tetapi juga antarmuka yang ergonomis dan mudah digunakan untuk karyawan, yang akan dapat memproses pembayaran tanpa bisa kabur dengan kasir;
- akhirnya, biaya penggunaannya lebih murah daripada jaringan perbankan tradisional 2 hingga 3%.

4. **ketika bisnis ini menerima Bitcoin**, maka akan mungkin bagi Anda:

- untuk **secara rutin berkunjung** untuk melakukan pembelian;
- untuk mengambil kesempatan untuk **bertanya apakah semuanya berjalan baik**, bahkan menawarkan kontak Anda lagi jika diperlukan;
- untuk **sekali lagi menyarankan datang ke pertemuan dan acara Anda**;
- untuk **menambahkan bisnis ini di [peta btcmap.org](https://btcmap.org/)**, dan memberitahu [Swiss Bitcoin Pay di Twitter](https://x.com/swissbitcoinpay) untuk memberikan visibilitas kepada bisnis ini; - tetapi juga untuk **berpotensi mengadakan acara di bisnis ini**, seperti pertemuan atau workshop.

![image](assets/fr/55.webp)

5. setelah beberapa bisnis di kota Anda telah bergabung dan telah memahami apa yang Bitcoin bawa untuk mereka, Anda kemudian dapat **mengusulkan pembuatan grup Telegram khusus untuk pedagang**; tujuannya adalah untuk **memungkinkan mereka saling membantu** dan untuk lebih lanjut dalam orange-pilling bisnis lain di kota. Secara paralel, grup ini juga dapat **bertindak sebagai dukungan teknis**, jika masalah muncul dengan pelanggan.

####

Tentu saja, **perekrutan ini adalah pekerjaan jangka panjang. Ini membutuhkan banyak waktu, motivasi yang meningkat, tetapi juga sedikit strategi**.
Apakah komunitas Anda merasa siap untuk membangun di kota Anda **dasar-dasar ekonomi sirkular Bitcoin**, mirip dengan [Arnhem di Belanda](https://www.arnhembitcoinstad.nl/)? Jika iya, lakukanlah!

## Menghubungi Pers dan Radio Lokal

<chapterId>435bfbc1-22dd-59bb-b737-a32ea995b238</chapterId>

Sering kali dilupakan, kami para bitcoiner umumnya berpikir bahwa sarana komunikasi terbaik adalah media sosial dan internet. Namun kami – sebagian – salah.

Beberapa komunitas (ini terjadi khususnya dengan [Breizh Bitcoin](https://breizhbitcoin.com/), di Prancis) telah membiasakan diri untuk **menghubungi pers lokal** mereka untuk:

- **Berbicara kepada mereka tentang acara yang mereka selenggarakan** (pertemuan, presentasi, workshop, pesta halving, dll.);
- **Mengundang mereka untuk menjelajahi bisnis lokal yang menerima Bitcoin, dengan tujuan menulis artikel** tentang subjek tersebut;
- tetapi juga, sederhananya, **untuk meminta mereka membagikan tanggal dan lokasi acara mendatang mereka**.

Memang, banyak koran lokal masih memiliki, di halaman terakhir atau kedua terakhir, daftar acara yang diselenggarakan di wilayah mereka.
Umpan balik dari Breizh Bitcoin jelas: ini berfungsi dengan baik, dan orang baru telah menghadiri pertemuan mereka setelah menemukan asosiasi mereka di koran.

Meskipun ini mungkin spesifik untuk lokalitas tempat Anda berada, berikut adalah daftar judul pers regional Prancis utama:
...
Secara paralel, juga bisa menarik untuk **menghubungi stasiun radio lokal, untuk mengusulkan, misalnya, pembuatan podcast atau wawancara**.
Namun, sadarilah bahwa kata-kata di media dapat dengan mudah diputar ke kerugian mereka. **Jadi, ini bukan tugas yang mudah, dan mungkin bijaksana untuk mempersiapkannya**.

![image](assets/fr/56.webp)

####

Tentu saja, **banyak proyek lain yang dapat direalisasikan**. Secara umum, semuanya akan tergantung pada waktu Anda, motivasi Anda; tetapi juga pada kesulitan proyek yang bersangkutan.
Dalam realisasi ini, **tiga nasihat** dapat membimbing Anda:

1. **tentukan terlebih dahulu langkah-langkah proyek, tujuan(nya), dan apa yang perlu dilakukan**;

# Mengantisipasi Masa Depan

<partId>6ea07445-9369-54bc-9aa0-d260db026e0b</partId>

## Merencanakan Peningkatan Peserta

<chapterId>8af722d4-3a9f-548c-9001-424f2142de12</chapterId>

Saat dunia memasuki epoch keempatnya, pada blok 840,000, semakin banyak individu yang melihat **Bitcoin sebagai revolusi teknologi, finansial, dan sosial**.
Sama seperti revolusi internet, revolusi ini tentunya akan **memerlukan waktu**, dan itu adalah hal yang baik. Hal ini akan memungkinkan semua orang untuk **mengedukasi diri mereka sendiri tentang dasar-dasar Bitcoin, dan belajar cara menggunakannya**. Tapi juga, ini akan memberi waktu bagi pengembang dan perusahaan untuk mengembangkan protokol dan aplikasi yang relevan, memungkinkan eksplorasi potensi penuh dari Bitcoin.
Meskipun mustahil untuk memprediksi masa depan, **peningkatan jumlah pengguna Bitcoin yang sangat signifikan dapat diantisipasi**, untuk **bersiap menghadapi semua situasi**. Termasuk yang paling kritis, seperti potensi implosi dari sistem keuangan tradisional; atau bahkan: larangan terhadap Bitcoin.

Dalam bagian kedelapan dan terakhir dari kursus ini, kami akan meluangkan waktu untuk merinci beberapa poin yang perlu dipertimbangkan ketika mengembangkan komunitas dan meet-up Anda.

####

Yang pertama di antaranya (yang paling mudah diantisipasi) jelas adalah **peningkatan jumlah orang yang bergabung dengan komunitas Anda**. Ini akan berdampak pada dua hal:

1. **saluran komunikasi Anda (Telegram, Signal, Matrix, dll...) akan penuh, berpotensi membuat percakapan sulit diikuti**. Dua poin kemudian perlu dipertimbangkan.
   Di satu sisi, jika Anda berjumlah 500 orang yang bertukar pikiran tentang berbagai topik dalam saluran diskusi yang sama, mayoritas anggota Anda akan secara bertahap berhenti mengikuti percakapan; di antaranya karena kelimpahan pesan yang harus dibaca dan notifikasi yang terkait. Dalam hal ini, mungkin relevan untuk **mempertimbangkan kembali saluran komunikasi Anda; seperti misalnya super-grup Telegram, atau bahkan server Discord**, yang keduanya memungkinkan pengelompokan percakapan berdasarkan tema.
   Di sisi lain, lebih banyak orang di saluran pertukaran juga berarti lebih banyak bot, lebih banyak penipuan, dan juga **lebih banyak moderasi yang harus dilakukan**. Anda akan perlu bersiap, dengan menyusun misalnya satu set aturan yang dapat Anda andalkan saat Anda memoderasi pesan. Dari pengalaman, ini menghindari sebagian besar konflik; terutama ketika aturan tersedia untuk dibaca di saluran komunikasi Anda. Dalam hal ini, asosiasi Bitcoin Lille beberapa tahun yang lalu menulis **[satu set aturan sumber terbuka](https://bitcoinlille.fr/reglement/) untuk grup Telegram dan server Discord-nya**, berdasarkan prinsip-prinsip sederhana dan universal. Desainnya [juga tersedia](https://www.canva.com/design/DAGHI692AD4/rjT4sqEnhajc5FiPA6GFZQ/edit?utm_content=DAGHI692AD4&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![gambar](assets/fr/57.webp)

2. **meet-up dan acara Anda akan penuh secara signifikan, dengan berlimpahnya wajah baru yang ingin bertukar pikiran satu sama lain**.
   Menghadapi masuknya yang signifikan ini, beberapa pendekatan dapat dibahas dan dipertimbangkan:

- Pertama-tama, mungkin relevan untuk **menemukan tempat yang lebih besar untuk mengorganisir pertemuan dan acara**, terutama jika Anda hanya dapat menampung sekitar dua puluh orang di tempat sebelumnya; - Kedua, jika Anda menyadari bahwa kehadiran manusia menjadi terlalu luar biasa, Anda juga dapat – untuk pertemuan selanjutnya – **meminta peserta untuk mendaftar** (ini dapat dilakukan melalui aplikasi Meetup, atau melalui formulir standar), **atau mengorganisir beberapa pertemuan dalam sebulan** (misalnya: pertemuan pemula, pertemuan menengah, dan pertemuan ahli);
- Selain itu, pasti banyak pemula di ekosistem yang akan bergabung dengan Anda, umumnya dengan tujuan untuk menghasilkan uang. **Agar percakapan tetap fokus pada Bitcoin selama pertemuan yang berkembang pesat ini**, disarankan:
  a) **untuk melakukan presentasi tematik tentang Bitcoin selama pertemuan ini**, karena ini akan selanjutnya mengarahkan sebagian besar peserta untuk mendiskusikan tema ini, dan bukan proyek baru yang disebut revolusioner;
  b) **tidak hanya berpegang pada bitcoiners, tetapi untuk mendekati pendatang baru, bahkan jika itu berarti mengambil inisiatif untuk tetap di belakang ruangan untuk menyambut mereka**. Diskusi kemudian dapat berputar di sekitar alasan mengapa orang-orang ini datang, apa yang mereka cari, tujuan (atau dasar) dari komunitas Anda, dll.

####

Akhirnya, meskipun sayang untuk dikatakan, **penipu mungkin muncul di pertemuan**. Tujuan mereka kemudian akan berbicara sebanyak mungkin tentang skema ponzi mereka, MLM mereka, atau "proyek blockchain revolusioner" mereka. Juga sepenuhnya masuk akal bahwa orang dengan niat jahat mungkin datang khusus untuk mencuci uang atau untuk membeli BTC dengan uang palsu.
Dalam situasi kompleks seperti ini, pendekatan paling sederhana adalah mengambil inisiatif untuk "dengan sopan" menjelaskan kepada individu-individu ini bahwa pertemuan tersebut bukanlah tempat di mana mereka akan berhasil, dengan menyajikan argumen x atau y (seperti, menginformasikan tentang keberadaan polisi rahasia).
Jika, sayangnya, individu-individu ini menolak untuk pergi atau mematuhi aturan kesopanan (yang telah terjadi sebelumnya), pengumuman verbal selama pertemuan yang menginformasikan bahwa satu atau lebih individu mencoba untuk terlibat dalam tindakan jahat tersebut dapat dibuat.
**Untungnya, situasi seperti ini jarang terjadi dan biasanya cukup khusus. Tapi lebih baik bersiap.**
Selain itu, jika ini dapat meyakinkan Anda sebagai penyelenggara, selama Anda tidak melanggar sendiri atau memfasilitasi pertukaran ilegal, Anda tidak perlu khawatir. Di Prancis, Anda memang tidak secara hukum bertanggung jawab atas tindakan orang lain.####
Dalam dunia yang ideal, maka akan lebih baik untuk memiliki tempat yang dapat menampung beberapa lusin orang (tergantung pada pertumbuhan komunitas Anda); tetapi juga, untuk **membangun hubungan yang kuat antara bitcoiners dan calon bitcoiners selama pasar bear**, sehingga Anda siap untuk **orange-pill selama bull run berikutnya**.

## Mendesentralisasi Organisasi Komunitas Anda

<chapterId>bedfc110-e099-58f4-a5b7-fb50f3b19a49</chapterId>

Anda adalah penyelenggara pertemuan dan, dalam semalam, **Anda memutuskan untuk menghentikan tugas ini** untuk pergi memelihara llama di Peru; hanya meninggalkan segalanya?

**Pertimbangkan untuk menyerahkan komunitas Anda dengan**:

1. **memberikan hak administratif (atau bahkan kepemilikan) dari saluran komunikasi kepada individu yang dipercaya**, bahkan jika itu berarti berganti tangan nanti;
2. **berbagi dengan setidaknya satu orang yang dipercaya di komunitas Anda nama akun, kata sandi, dan email dari akun dan jaringan sosial** yang Anda buat untuk memberinya visibilitas.
   Tanpa hak dan pengenal ini, akan mustahil bagi siapa pun untuk **dengan mudah mengambil alih dan melanjutkan inisiatif yang telah Anda kembangkan dengan begitu banyak waktu**. Memulai dari awal dengan membuat jaringan dan saluran "forked" memang membutuhkan banyak waktu dan energi…

**Jadi, antisipasi kepergian potensial Anda** ke Peru. Dan jika Anda, di Prancis, tidak memiliki anggota terpercaya dalam pertemuan Anda, Anda selalu dapat menghubungi @ProfEduStream atau @gabtribe di Telegram untuk membuat transisi ini dengan lancar.

####

Ini membawa kita ke **titik krusial dalam pengembangan sebuah komunitas: desentralisasinya**.
Memang, jika Anda adalah satu-satunya orang yang terlibat di dalamnya, memiliki semua kontrol, apa yang akan terjadi jika Anda menghilang? Jawabannya sederhana: komunitas Anda akan menghilang.

Cara terbaik untuk menghindari ini adalah dengan **mendesentralisasi tugas dan berbagi hak, peran, dan akses**. Dengan demikian, jika salah satu anggota tim penyelenggara komunitas atau pertemuan Anda ditangkap dalam distopia masa depan karena mereka memiliki Bitcoin non-KYC (atau sederhananya: karena mereka tidak lagi memiliki waktu untuk mendedikasikannya karena baru saja memiliki anak atau berganti pekerjaan), yang lain dapat melanjutkan misi mereka tanpa kesulitan.

####

Dalam upaya mendesentralisasi lebih lanjut, **menggunakan perangkat lunak sumber terbuka seperti suite framasoft** juga dapat menjadi "garis pertahanan" pertama terhadap negara fiksi yang akan menyensor Bitcoin. Menggunakan alat komunikasi yang terenkripsi - bahkan anonim - adalah yang kedua.

## Bagaimana jika Bitcoin menjadi musuh umum no. 1?

<chapterId>c739651f-cd13-51e0-a36e-85023749b15b</chapterId>

Pada 5 April 1933, Franklin Roosevelt, saat itu presiden Amerika Serikat yang ke-32, menandatangani Perintah Eksekutif 6102, yang melarang setiap individu dari memiliki koin emas, emas batangan, dan sertifikat emas di seluruh wilayah.

![image](assets/fr/58.webp)

Jelas, Depresi Besar (kejatuhan pasar saham tahun 1929) saat ini tidak lagi relevan. Tapi siapa yang bisa mengatakan bahwa, besok, negara lain tidak akan melakukan hal yang sama dan **melarang setiap individu dari memiliki bitcoin?**

####

Untungnya, distopia Orwellian ini tidak akan mencegah siapa pun dari benar-benar memiliki bitcoin mereka, karena mustahil untuk menghentikan siapa pun dari mempelajari urutan kata-kata.
Tapi apa yang akan terjadi **jika para pemimpin dunia kita akhirnya memahami bahwa Bitcoin memiliki kapasitas untuk mengubah tatanan dunia, termasuk di tingkat negara?** Apakah Bitcoin kemudian akan menjadi **"musuh umum no. 1"?**

####

Tentu saja, kita tidak seharusnya terjebak dalam bentuk pemikiran konspirasi. Tapi **tidak ada yang menghalangi kita, dari sekarang, untuk mengantisipasi, mendesentralisasi, dan mendidik**.
...
## Rencana aksi yang diringkas untuk menciptakan komunitas Bitcoin Anda

<chapterId>1f463ec2-3f64-5641-8d60-e02a47c94f27</chapterId>

Satoshi Nakamoto menciptakan alat revolusioner yang memiliki kapasitas untuk mengubah dunia seperti yang kita kenal. Namun, sudah pasti bahwa **terserah kepada kita, para bitcoiner, untuk memilih trajektori yang ingin kita ambil untuk membangun masa depan**.
Secara paralel, esensi Bitcoin menjadikannya sebuah lubang kelinci yang luas, memotong begitu banyak aspek sejarah, ekonomi, sastra, matematika, ilmu komputer, dan kriptografi sehingga mustahil untuk mencakup semuanya. Ini sebagian merupakan keindahannya. Sebagai manusia, kita hanya memiliki jumlah waktu yang terbatas selama hidup kita. **Dengan tetap rendah hati dan belajar dari orang lain** setiap dari kita akan dapat mencapai tujuan yang telah kita tetapkan untuk diri kita sendiri dalam memahami Bitcoin.
**Komunitas Bitcoin global oleh karena itu memainkan peran fundamental dalam membangun dunia esok**; komunitas di mana para bitcoiner dapat **bertukar, membangun, dan berbagi**. **Bersama**.

####

Seperti yang akan Anda pahami dari kursus ini, **menciptakan sebuah komunitas dan pertemuan Bitcoin** memerlukan organisasi dan motivasi. Tentu saja, tergantung pada keinginan Anda dan waktu yang Anda dedikasikan untuk itu, Anda akan pergi lebih jauh atau kurang jauh dalam proyek-proyek tersebut.
Namun demikian, tujuannya tetap sama: **menyalakan percikan agar Bitcoin tumbuh di kota Anda**.

####

Untuk merangkum banyak bab dan sub-bab dari kursus ini, berikut ini adalah **"rencana aksi" ringkasan untuk menciptakan komunitas Bitcoin Anda**:

1. tentukan terlebih dahulu mengapa Anda ingin menciptakan komunitas Bitcoin, untuk tujuan apa, di mana, dll.;
2. mendekati komunitas yang sudah ada di sekitar Anda dengan membuat kontak dan/atau meminta saran;
3. ciptakan identitas unik untuk komunitas dan lokasinya (logo, poster, spanduk, flyer, dll.)
4. buat saluran komunikasi dan jejaring sosial seperti Telegram, Twitter, NOSTR, Discord. Juga pertimbangkan saluran yang terdesentralisasi dan/atau tidak dapat disensor;
5. mendekati pertemuan dan komunitas tetangga (terutama di media sosial) dan daftarkan diri Anda di berbagai peta dan platform untuk mendapatkan visibilitas;

Setelah saluran komunikasi komunitas Anda cukup berkembang:

6. usulkan pertemuan tipe kumpul-kumpul melalui survei;
7. pikirkan tentang tujuan yang ingin Anda capai dari acara fisik ini;
8. cari tempat yang terletak dengan baik, menyambut yang memenuhi tujuan Anda dan pesan meja;
9. seminggu sebelum acara, komunikasikan tentang itu di jaringan dan saluran komunikasi Anda. Ulangi ini dua hingga tiga hari sebelum tanggal penting;
10. daftarkan acara Anda di platform dan situs web yang sesuai, jika memungkinkan;
11. pada hari pertemuan, biarkan hal-hal terjadi dan pergi ke arah orang lain, bahkan jika itu berarti dengan lembut mengarahkan kembali percakapan jika perlu;

Tindak lanjut:

12. berusaha untuk mempertahankan dan melibatkan sebanyak mungkin anggota dan peserta agar mereka kembali;
13. Usulkan ide proyek dan inisiatif sederhana, dan mulai menerapkan yang secara pribadi penting bagi Anda. Jika ada orang lain yang ingin mengatur sesuatu yang berbeda, jangan ragu untuk membantu berdasarkan tugas dan tujuan yang diinginkan;
    Akhirnya:
...
15. Mulai mendemokrasikan penerimaan Bitcoin di bisnis kota Anda, dengan bertanya apakah mereka menerima Bitcoin, misalnya;
16. Desentralisasi tugas di antara individu yang dipercaya, serta hak atas saluran dan jaringan Anda;
17. Promosikan komunitas Anda agar semakin banyak orang bergabung, dan libatkan individu yang tertarik;
...
Bagaimanapun, **ingat bahwa Anda tidak sendirian dan bahwa komunitas yang ada ada untuk membantu Anda**.

## Kursus BTC302

<chapterId>8bf10b77-80ee-5d50-87bc-0ef32574a675</chapterId>
Dalam kursus BTC302 ini, kami telah merinci langkah-langkah untuk membuat sebuah komunitas, sebuah pertemuan; tetapi juga, implementasi dari berbagai proyek.

Ketika komunitas Anda merasa siap untuk naik ke level selanjutnya, **memungkinkan untuk membuat sebuah asosiasi**.
Di Prancis, misalnya, dari sekitar lima puluh komunitas dan pertemuan, ada hampir sepuluh asosiasi.

####

Minat dalam membuat satu adalah dua kali lipat:

- di satu sisi, status sebagai asosiasi memungkinkan untuk **memiliki status resmi, membuka rekening bank asosiasi, dan juga mendapatkan bentuk pengakuan dari pers, media, dan subsidi**;
- di sisi lain, ini memungkinkan **organisasi yang lebih tepat dari operasi komunitas dan implementasi proyek-proyeknya**, dengan mendefinisikan peran spesifik.

####

Dengan tujuan untuk lebih mengembangkan komunitas Anda, **sebuah kursus bernama COMMU201 akan dirilis di [planb.network](https://planb.network/) dalam beberapa bulan mendatang**.

Melalui kursus ini, **kami juga akan menjelaskan poin penting lainnya: organisasi acara skala besar, dengan sekitar seratus peserta**. Kami akan membahas pertanyaan seperti: Mengapa? Organisasi seperti apa? Di mana? Anggaran berapa? Bagaimana? Operasi seperti apa?
Untuk mencapai ini, kami akan memulai dengan pengalaman dari beberapa komunitas Prancis yang telah mengorganisir acara mereka sendiri, seperti **BEF (Bitcoin Economic Forum, pada Mei, di Brittany) dan B-only (pada November, di Annecy)**.

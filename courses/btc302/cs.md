...
Navíc, **protože Bitcoin je inkluzivní, zdá se, že role komunity je zmocnit a vzdělávat všechny budoucí bitcoinery o základech Bitcoinu**; včetně těch nejvíce váhavých.
####
...
Předtím, než začnete, je však nezbytné předvídat další krok: potenciální setkání. Jinými slovy meet-up!
...
Samozřejmě, v závislosti na vašich odpovědích, nebudou vaše pozice a motivace stejné.
...
To je důvod, proč **byl tento kurz vytvořen s cílem sdílet všechny možné zdroje a tipy, aby vaše komunita mohla růst a stát se autonomní**.
...
- V Monaku odkazuje na monackou skálu:
...
- **plakát oznámení společné události** (pro sociální sítě a tištěný ve formátu A4 nebo A3): [odkaz](https://www.canva.com/design/DAGBvG3rNCc/oXtNR9pduRs22AqclG4O2g/edit?utm_content=DAGBvG3rNCc&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton)
...
## Které komunikační kanály dát na první místo?
...
K nápravě tohoto stavu lze použít několik řešení:
...
Je také **vysoce doporučeno napsat popis vašeho setkání při vytváření skupiny nebo supergroup na Telegramu**, protože to uvidí kdokoli, kdo se bude chtít připojit. To by mohlo být například:
...
Malá poznámka: jak bylo zmíněno dříve, nyní lze celý tento postup provést i na telefonu.
...
# Spuštění vašich sociálních sítí
...
Navíc se **zdá být relevantní změnit některá nastavení soukromí**; nejpříhodnější je zřejmě:
...
## Propojení se sousedními setkáními
...
Je zcela možné, jen několik týdnů po vytvoření komunity, zahájit událost typu meet-up.
...
![obrázek](assets/fr/chapter21/34bis.webp)
####
...
![obrázek](assets/fr/chapter22/35.webp)
...
## Organizujte tematická setkání, s definovaným ročním postupem
...
**Klidně si tyto zdroje vezměte, upravte je a sdílejte, jak chcete**. Jen si pamatujte na **citování vašich zdrojů**, pokud znovu použijete upravitelnou prezentaci.
####
...
Nicméně je třeba poznamenat, že 1000 samolepek je významné množství. Proto je jasně **preferováno začít s nákupem stovky samolepek**; abyste si byli jisti prodejem tohoto skladu.
...
## Vytvořte přizpůsobené letáky a distribuujte je
...
- **účastníky vašich akcí**, s letákem konkrétně vysvětlujícím, jak používat a platit v Bitcoinu / Lightning; - a **nováčky**, potkané na ulici, v práci nebo na rodinném obědě, s letákem shrnujícím hlavní výhody Bitcoinu.

Je také zcela možné připravit **leták specifický pro vaši komunitu nebo setkání, prezentující vaše akce, cíle, sítě a komunikační kanály; ale také data a místa vašich již naplánovaných akcí**.
####
Několik letáků je již **dostupných jako open-source**, a další budou vytvořeny v nadcházejících měsících. Najdete je zejména **v [Bitcoin Educational Toolkit od planB.network](https://planb.network/fr/resources/bet)**.

Mezi nimi najdete [komplexní zdrojový leták](https://profedustream.substack.com/p/21-raisons-dutiliser-bitcoin) uvádějící 21 důvodů pro použití Bitcoinu. Jeho design je také [dostupný jako open-source](https://www.canva.com/design/DAFtAR1NauQ/ZDwl2CchIJ9Gpb36N6-7iw/edit?utm_content=DAFtAR1NauQ&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![image](assets/fr/chapter27/41-fr.webp)
![image](assets/fr/chapter27/42-fr.webp)

Upravte je, přizpůsobte a poté sdílejte, jak uznáte za vhodné. Nicméně nezapomeňte citovat vaše zdroje.
#### 
Jak bylo zmíněno dříve, **tyto letáky můžete umístit prakticky kamkoli**: na společný stůl ve vaší práci, na stůl během rodinného oběda, do městské knihovny atd.

Ve Francii a v několika dalších zemích existují také **"knihovní boxy"**.
Obvykle vyrobené ze dřeva, tyto boxy volně přijímají knihy k darování. Jednou z možností by tedy mohlo být **nechat tam leták; nebo ještě lépe: knihu!**

![image](assets/fr/chapter27/43.webp)
![image](assets/fr/chapter27/44.webp)

V této souvislosti byl v roce 2023 zahájen projekt **"Bitcoinový bílý papír v knihovních boxech Francie"**.
Pro úspěšné provedení tohoto projektu se všemi zainteresovanými stranami bylo nejprve nutné **získat geolokaci všech existujících knihovních boxů v zemi**. K tomu existují různé databáze:
...
- [delivrez.fr](https://delivrez.fr/maps/fr_FR/);- stejně jako několik článků v místním tisku.
Samozřejmě, umístění bílé knihy Bitcoinu do těchto knižních výměn má symbolický význam. Avšak pro nováčka je příliš složité ji pochopit. Myšlenka tedy byla **napsat malou brožuru, obsahující**:
- **zjednodušený a zdokumentovaný úvod do Bitcoinu, jeho použití a problémy, které řeší**;
- a **bílou knihu Bitcoinu**, přeloženou do francouzštiny.

Zde je brožura, která byla sdílena mezi francouzskými bitcoinisty [brožura, která byla sdílena mezi francouzskými bitcoinisty](https://profedustream.substack.com/p/bitcoin-la-naissance-dune-nouvelle) a která zakončila svou cestu v několika desítkách knižních výměn po celé zemi. Její design je také [dostupný jako open-source](https://www.canva.com/design/DAFs18FSoVM/Sy0QsfUkycTgXveeGgutBg/edit?utm_content=DAFs18FSoVM&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![obrázek](assets/fr/chapter27/45-fr.webp)
![obrázek](assets/fr/chapter27/46-fr.webp)

## Organizace promítání videa
<chapterId>892b248a-b837-5df6-aac9-4b3261ff0390</chapterId>

Každý bitcoinista určitě již viděl velmi zajímavou mini-sérii "The Satoshi Mystery, at the Origins of Bitcoin" od [Rémi Forte](https:/https://twitter.com/forteremi).
Vydaná v roce 2021, byla zhlédnuta [několik milionůkrát na YouTube](https://www.youtube.com/watch?v=0ETcLj5jBy4), jelikož představuje stimulující první krok k pochopení, odkud Bitcoin pochází.
V tomto smyslu je zcela možné **navrhnout promítání této mini-série vaší komunitě**; dokonce vytvořit například speciální událost.

Existuje však malý háček: ve Francii jsme kontaktovali ARTE, abychom ověřili, zda je toto právně možné. Bohužel kvůli **právům na promítání** byla cena za promítání téměř 250€; s možnou slevou 120€ za promítání, pokud by 5 setkání uspořádalo jedno během roku.
V důsledku toho je pro většinu komunit tato sazba nepřijatelná. Přesto je dokumentární film dostupný zdarma na ARTE...
####
Paralelně mohou být organizována další promítání.
Ve Francii například **režisérka dokumentárního filmu "Stranded", [Alana Mediavilla](https://twitter.com/AlanaMediavilla), souhlasila, že nechá promítat svůj dokument na setkáních v zemi v předpremiéře**; některé záběry pocházejí ze sekvencí [filmu "Dirty Coin"](https://www.dirtycointhemovie.com/), který bude vydán v roce 2024.
Francouzská bitcoinová komunita poté převzala iniciativu a **kompletně přeložila dokumentární film "Stranded"**, začlenila francouzské titulky a sdílela jej se všemi setkáními po celé zemi. Během týdne od 4. března 2024 bylo **pořádáno společné promítání na asi deseti setkáních po celé zemi**.
![obrázek](assets/fr/chapter28/47.webp)

Toto vysílání vedlo k mnoha diskusím o těžbě Bitcoinu, jeho spotřebě elektřiny a širším dopadu na ekologii.

## Vylepování plakátů ve vašem městě
<chapterId>6565e8a0-d535-5be0-9764-273584c675bd</chapterId>
V několika evropských zemích (Německo, Španělsko, Francie atd.) **někteří příznivci Bitcoinu přijali iniciativu a začali vylepovat plakáty související s Bitcoinem**. Některé z těchto plakátů poté obsahují díla od Banksyho, zatímco jiné různými způsoby inkorporují logo Bitcoinu.
To je případ zejména pro [StreetCyberArt](https://twitter.com/streetcyber_art), německého příznivce Bitcoinu, který již několik let tvoří koláže a street art.

![obrázek](assets/fr/chapter29/48.webp)
####
Samozřejmě, pokud se chcete zapojit do vylepování plakátů na ulici, bude nutné **být obeznámeni se zákony ve vaší zemi**. Ve Francii je například povoleno **vylepovat plakáty pouze na veřejných nástěnkách**. Jinak je to zakázáno a může to vést k pokutě.
Zřejmě platí: **co oči nevidí, to srdce nebolí**. Takže v tomto případě možná buďte opatrní, abyste na tyto plakáty nezahrnuli žádný prvek, který by vás mohl prozradit (název setkání, @ Twitter atd.)

Pokud plánujete **tisknout tento typ plakátů na osobní tiskárně, mějte na paměti, že to obvykle způsobuje silné rozmazání papíru, ale také jeho rychlé zhoršení v průběhu času**. V tomto smyslu je **nejlepším řešením určitě kontaktovat profesionální tiskárnu, aby tyto plakáty vyrobila na specifickém samolepicím papíře, speciálně určeném pro venkovní použití**. Kvalita bude tímto zajištěna.

![obrázek](assets/fr/chapter29/49.webp)
####
Nicméně nelze popřít, že **tato iniciativa má významné náklady: více než 0,40€ za plakát (tj. 40€ za sto plakátů)**; a to, když máte dobré kontakty. Online ceny se skutečně mohou lišit od dvojnásobku až po pětinásobek.

Jak bylo zmíněno dříve, francouzský příznivec Bitcoinu [@Mill3sim3](https://twitter.com/Mill3sim3) má vhodné profesionální vybavení. Proto ho můžete kontaktovat na Twitteru pro informace.

## Vlastnění vlastní NFC karty
<chapterId>8ad65d4e-a68a-59c2-a812-85f4907ed9f3</chapterId>
Dalším unikátním projektem je **vytváření personalizovaných NFC karet pro platby pomocí Lightning**, v souladu se standardem BoltCard. Pro tento účel je **Swiss Bitcoin Pay** kvalitním partnerem.

Aktuálně na jejich webových stránkách na [https://swiss-bitcoin-pay.ch/cards](https://swiss-bitcoin-pay.ch/cards) nabízí Swiss Bitcoin Pay čtyři základní designy.
Pokud si přejete objednat **více než 50 NFC karet, můžete kontaktovat společnost na jejím oficiálním webu (nebo na [Twitteru](https://twitter.com/SwissBitcoinPay)) a navrhnout vlastní design**, který jste vytvořili pro přední stranu karty. Zadní strana je nicméně standardizovaná.

![obrázek](assets/fr/chapter30/50bis.webp)

Například [francouzská asociace Bitcoin Lille](https://twitter.com/BitcoinLille) objednala v roce 2023 stovku NFC karet s vlastním designem za **cenu přibližně 2,50€ až 5€ za kartu** (sazba se pravidelně mění a je progresivní).
Takto **každý nový člen asociace obdrží ve svém uvítacím balíčku personalizovanou NFC kartu**.

Tento nápad je samozřejmě možné dále rozvíjet a vylepšovat dle vašich představ.

## Vytvoření webové stránky
<chapterId>9a2a1b9b-0633-544a-b331-c06187d23d7f</chapterId>
S cílem mít výkladní skříň pro vaši komunitu, setkání, akce a vzdělávací dokumenty, může být v určitém okamžiku relevantní **mít webovou stránku**. Nicméně, **návrh stránky zabere hodně času** (několik desítek hodin).

Aby se úkol tvorby zjednodušil, níže uvedený tutoriál vám za půl hodiny ukáže kroky k vytvoření **bezplatné webové stránky na platformě WordPress**. Tento web vám umožní **mít přizpůsobitelnou úvodní stránku, vytvářet kategorie, publikovat články, integrovat média (videa z YouTube, obrázky, PDF)** atd.
Později budete moci zakoupit vlastní doménové jméno a dokonce jej hostit na vašem osobním serveru, pokud budete chtít.

<videoId>56e302c2-b42c-4a4e-88fc-af207232f5ae</videoId>
####
Jiné CMS nebo platformy také umožňují tvorbu webových stránek. Ačkoli některé jsou jednodušší díky svému uživatelsky přívětivému rozhraní, výsledné webové stránky jsou také mnohem méně přizpůsobitelné.
**WordPress se zdá být nejrelevantnější volbou pro začátek**. Navíc umožňuje **integraci plug-inů**, z nichž některé jsou placené, ale vysoce kvalitní, což umožňuje daleko větší rozvoj webové stránky; a to bez nutnosti kódování.
[Uncode plugin](https://undsgn.com/uncode/), který je placený, je jedním z nich.

## Vytvoření video kanálu (YouTube nebo Odyssee)
<chapterId>076286db-1627-57ec-a410-c44b1666e1cd</chapterId>

Mezi členy vaší komunity mohou být někteří, kteří mají zájem o **tvorbu multimediálního obsahu**. To by například mohlo mít podobu produkce tutoriálních videí (použití software peněženky, tutoriál pro nákup BTC bez KYC atd.)
Paralelně může nastat den, kdy budou na vašich setkáních prezentovány prezentace. Nebo dokonce, když vaše komunita provádí konference na vysokých školách a univerzitách.

V tomto smyslu, **když nastane potřeba, může být relevantní mít video kanál, který vám umožní online zveřejňovat všechna videa, prezentace a konference vytvořené jako součást vašich akcí a projektů**.
####
Mezi nejznámější video platformy patří:
- [**YouTube**](https://www.youtube.com/), který má nedostatek v tom, že **není odolný vůči cenzuře**;
- [**Odyssee**](https://odysee.com/), který je poměrně málo používaný, ale je **decentralizovaný** díky svému peer-to-peer provozu;
- [**peertube**](https://joinpeertube.org/fr_FR), který vám umožňuje vytvořit vlastní video platformu. To je pravděpodobně krok výše z hlediska nastavení.

V závislosti na tom, co se rozhodnete implementovat, budete samozřejmě potřebovat **vytvořit vizuály specifické pro tuto platformu**, s cílem udělat váš video kanál vizuálně atraktivní. Pozitivním bodem je, že s **Canva**, o které jsme diskutovali v [části 2/8 tohoto kurzu](LINK), existuje kategorie "YouTube Thumbnail" s již navrženými vizuály, které jsou snadno upravitelné.

![obrázek](assets/fr/chapter31/51bis.webp)
####
V případě, že si přejete **nahrávat na svém počítači, software jako ["Streamlabs"](https://streamlabs.com/fr-fr) funguje velmi dobře**. Umožňuje vám upravit mnoho nastavení, je zdarma a také umožňuje přechody scén.

Pokud jde o **úpravu videa** (pokud je nějaká), budete potřebovat vhodný software.
Pokud ještě nemáte, software ["Wondershare Filmora"](https://filmora.wondershare.fr/) je obzvláště účinný a velmi snadno použitelný; umožňuje vám provádět seriózní úpravy. Bohužel je placený (45 € za rok). Nakonec, pro **intro a outro** vašeho videa, konkrétní vyhledávání na **Canva** vám umožní najít to, co hledáte, upravit výstupy, jak si přejete, stáhnout je; a poté už budete muset jen integrovat je do vašeho střihového softwaru.
Poznámka: v případě, že by jednoho dne byl Bitcoin zakázán nebo cenzurován, mohlo by být relevantní vždy **mít lokální kopii videí** na pevném disku.

## Vytvoření audio podcastu
<chapterId>12e96b45-1c33-5687-a753-80d0114d487a</chapterId>

Vytvoření audio podcastu může být také zajímavá iniciativa. Stejně jako při vytváření video kanálu, však neočekávejte, že rychle získáte tisíce zhlédnutí.

Mezi nejznámější platformy pro podcasty patří:
- [**Fountain**](https://www.fountain.fm/), který je obzvláště zajímavý, protože umožňuje přímé dary v Lightning;
- [**Soundcloud**](https://soundcloud.com/);
- [**Deezer**](https://www.deezer.com/fr/);
- [**Spotify**](https://open.spotify.com/);
- [**Google podcast**](https://podcasts.google.com/).

Problém však je, že **každá z těchto platforem má velmi specifické publikum**. Abychom dosáhli co největšího počtu lidí, bude nutné být přítomni na všech z nich.

Naštěstí platforma **["Spotify for podcasters"](https://podcasters.spotify.com/)** umožňuje importovat váš podcastový soubor jednou a poté vygenerovat RSS feed, který lze kopírovat a vložit na kteroukoli z dříve zmíněných platforem**.
Takže, jakmile je práce hotová na "Spotify for podcasters", zůstává už jen formátování na vašich ostatních platformách; což je relativně rychlé.
####
V případě, že byste chtěli **nahrávat na svém počítači, zdarma dostupný software jako ["Audacity"](https://www.audacityteam.org/) funguje velmi dobře**. Umožňuje vám upravit mnoho nastavení, provádět crescenda a dokonce zlepšit čistotu zvuku při úpravě. Nahrávání vašeho hlasu a poté úprava zvuku vašeho podcastu by tedy mělo být poměrně snadné.

Zde je krátký tutoriál představující, za 10 minut, hlavní funkce, které je třeba znát pro vytvoření podcastu s Audacity.
<videoId>56e302c2-b42c-4a4e-88fc-af207232f5ae</videoId>

Poznámka: jak bylo zmíněno dříve, v případě, že by jednoho dne byl Bitcoin zakázán nebo cenzurován, mohlo by být relevantní vždy **mít lokální kopii podcastů** na pevném disku.

## Vytvoření odznaku pro vaše akce
<chapterId>0cccef8d-a765-5844-8921-c40f0ce653e4</chapterId>

Během vašich setkání a akcí je možné navrhnout malou motivaci k účasti. Nápad by pak byl **vytvořit typ odznaku, který lze získat pouze na dané akci**. To existuje pod názvem "POAP" ("Proof Of Attendance Protocol") na jiných blockchainech. V současné době však neexistuje žádný způsob, jak toto nastavit na Bitcoinu zdarma.
V principu by tato iniciativa mohla také sloužit k **odměňování nejaktivnějších členů vaší komunity, například organizováním roční tomboly**, při které by získaná odznak odpovídal losu do tomboly. Člen, který se zúčastní všech 12 setkání během roku, by pak měl 12 losů do této roční tomboly.
Kromě toho, v úplně jiném duchu, je také možné **na každé akci požádat účastníky, aby si na odznak napsali své křestní jméno nebo pseudonym**. K tomu mohou být přidány také důvody jejich účasti.
Tato strategie, ačkoli trochu formální, může některým členům umožnit **snadněji najít společnou řeč a témata k diskuzi**, zároveň také usnadňuje **nováčkům identifikaci organizátorů** a potenciálních členů sdružení.

Několik modelů používaných sdružením Bitcoin Lille je také [dostupných jako open-source na Canva](https://www.canva.com/design/DAGHAsT15MU/AIA7-L_xBjNdsuxdD4-h-Q/edit?utm_content=DAGHAsT15MU&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![obrázek](assets/fr/chapter32/52-frter.webp)

## Přemýšlení o přechodu v případě smrti
<chapterId>c5febf18-235c-51bc-8fbb-9467dabe4cb0</chapterId>

Další bod, na úplně jiné téma, je postoj k **smrti člena vaší Bitcoin komunity**.
Bohužel může nastat den, kdy vás rodina jednoho z vašich bývalých členů kontaktuje s oznámením, že tato osoba zemřela. Poté vysvětlí, že **tento jedinec zanechal instrukce**, a jednou z nich je **kontaktovat vaši komunitu / setkání / sdružení**.
Tato osoba pravděpodobně vysvětlí, že **potřebuje pomoc s obnovou prostředků**, jelikož je beneficientem dědictví tohoto bývalého člena.

V reakci na tuto žádost může být velmi relevantní **mít již promyšlený určitý druh postupu, který by se měl následovat**; a to z několika důvodů.
Na jedné straně:
- zajistit, že zesnulý předem informoval svou rodinu, aby nikdy na setkání neprozrazovala ani nepřinášela soukromé klíče a fyzické peněženky zesnulého;
- aby rodina jasně chápala, že **jejich účast je o učení se o Bitcoinu**, aby se nakonec mohli stát suverénními nad prostředky zesnulého;
- aby **rodina byla informována o zákonech, které platí v zemi v případě darování, dědictví nebo konverze do fiat měny**;

Kromě toho, přemýšlení dopředu o postupu, který by se měl následovat, také zajišťuje, že nikdo, ať už člen setkání nebo jen host, nemůže tuto situaci jakkoliv využít ve svůj prospěch (a/nebo ukrást prostředky).

S tímto cílem by mohlo být zajímavé **navrhnout "pracovní skupinu" na postup, který by se měl přijmout v případě smrti a žádostí o pomoc přicházejících od rodiny**. Sdružení Bitcoin Lille skutečně pracuje na tomto bodu a svůj konečný pracovní dokument zveřejní v open-source způsobem [zde](https://docs.google.com/document/d/1TDfLZjuictC5s3PEM2Z7WmkxIDSJ8Q1E4xevm52pVgU/edit?usp=sharing) za několik měsíců.

## Pořádání konferencí ve školách a na univerzitách
<chapterId>65efdb44-e3d4-567c-aedf-972765753d73</chapterId>
Seznam projektů, které byly dříve popsány, není samozřejmě vyčerpávající. Obecně se jedná o projekty interní pro komunitu/setkání, které lze poměrně snadno zorganizovat, jakmile vaše komunita nabere na síle. Nyní je tedy čas zabývat se procesem začlenění nováčků.

Především si jste nepochybně vědomi, že **jedním z nejlepších způsobů, jak mluvit o Bitcoinu s co největším počtem lidí současně, je samozřejmě pořádání konference** (nebo workshopu). To lze provést **na vysokých školách a univerzitách**; a tím vést mladé (a možná i ne tak mladé) lidi k objevování nebo prohlubování jejich porozumění Bitcoinu.

Kromě důležitosti **umění veřejně mluvit** vyžaduje pořádání konference před několika desítkami nebo dokonce stovkami lidí také **umění zvládat stres, artikulaci a čas**. Vyžaduje také **přípravu kvalitní prezentace nebo workshopu, který je podložený a odpovídá úrovni dovedností publika**, se kterým budete čelit.
Dále je nezbytné **mít otevřenou mysl, připravenou zjednodušit koncepty podle potřeby**, což je zásadní v tomto druhu cvičení; zejména během fáze otázek a odpovědí a v případě panelové diskuse. To neznamená "opustit své principy"; ale jednoduše přijmout, že ostatní mohou mít odlišný názor, i když to znamená odpovědět později nebo to nechat být, aby dialog mohl pokračovat. Každopádně, pokud jsou **vaše řeč a vaše odpovědi založeny na relevantních a podložených argumentech**, publikum nebude oklamáno.
Takže, pokud se cítíte schopni: jděte do toho! Náš svět takové vzdělání o tom, co Bitcoin je, tak zoufale potřebuje...
Nicméně je samozřejmé, že k dokončení tohoto úkolu **budete potřebovat hodně motivace, velké množství práce; ale také správné kontakty**.

![image](assets/fr/chapter33/53bis.webp)
####
Skutečně, **organizování konference nebo workshopu na škole a/nebo univerzitě není snadný úkol**.
Za prvé, je nutné **získat kontakt**. Toho lze dosáhnout **přes známého, přes BDE ("Bureaux Des Étudiants" nebo Studentské kanceláře); nebo dokonce studentské asociace**, které obvykle každý rok organizují cykly konferencí a setkání. Vaši **bývalí profesorové z inženýrské školy a/nebo univerzity** mohou také působit jako prostředníci.
V případě školy po maturitě je také možné **přímo kontaktovat osobu odpovědnou za vzdělávací program**, s cílem vysvětlit váš návrh. To pak může vést k úvodní schůzce a – v nejlepším případě, o několik týdnů později – k prezentaci o tom, co Bitcoin je a jak funguje před studenty.
####
Bohužel, v našem současném světě je Bitcoin stále příliš často záměrně démonizován médii a politiky; což vede mnoho nováčků k myšlence, že by měl být zakázán ve třídách a přednáškových sálech. **Pravděpodobnost, že se setkáte s mnoha odmítnutími, je tedy poměrně vysoká**; zejména v akademické sféře, kde se Bitcoinova proof of work a spotřeba energie někdy jeví jako tabu.
Nicméně, nic vás nebrání v pokusu, zejména s BDE a studentskými asociacemi. **S trochou štěstí, i když je odmítnutí pevné poprvé, není nemožné, že budete znovu kontaktováni během příštího bull-run na emailovou adresu vaší komunity, abyste přednášeli před téměř 280 studenty!**

![image](assets/fr/chapter33/54bis.webp)

## Přístup k podnikům
<chapterId>b730462b-7928-5d28-a14f-9ceaa773d3d2</chapterId>
Dosáhnout cíle **získat akceptaci Bitcoinu jako platební metody obchodníkem** je pro mnoho nadšenců Bitcoinu jakýmsi "Svatým grálem". Je to jako odemknout úspěch ve svém Pokédexu! Avšak, jelikož každý obchodník je jiný, úkol není snadný; a vzniká mnoho problémů:
- **obchodník stále potřebuje fiat měnu na platbu dodavatelům (zatím)**;
- **potřebují jasné a výslovné finanční zprávy**, které mohou poslat svým účetním;
- **jejich platební metody musí fungovat bez jakýchkoli technických nebo logistických problémů**, a zaměstnanci musí být schopni přijímat platby, aniž by mohli utéct s pokladnou.

K těmto problémům přidejte:
- **potenciální předsudky** obchodníka vůči Bitcoinu;
- **obtížnost najít softwarové řešení**, které funguje perfektně;
- ale také **důležitost přimět je pochopit výhody akceptace Bitcoinu** jako platební metody.

![obrázek](assets/fr/chapter34/56.webp)
####
Rozvoj ekosystému Bitcoinu ve vašem městě tedy může zahrnovat **zapojení obchodníků**. Nejjednodušší způsob, jak toho dosáhnout, je **postupovat krok za krokem**:

1) jakmile vstoupíte do obchodu, **vždy se zeptejte, zda můžete platit Bitcoinem**. To obvykle vyústí v odmítnutí a výraz plný otázek, ale tato jednoduchá otázka postupně povede obchodníky k tomu, že uvidí, že Bitcoin mohou používat "normální lidé" a že jako platební metoda získává mezi populací na zájmu. Můžete dokonce **poslat dva nebo tři lidi do stejného obchodu, v několikadenních intervalech, s žádostí o platbu Bitcoinem**. V určitém okamžiku to upoutá pozornost obchodníka;

2) jakmile začnou mít zájem nebo se zeptají, co Bitcoin je, můžete jim **vysvětlit stručně a srozumitelně**. Například, že Bitcoin je měna, nekontrolovaná bankami, bez důvěryhodného prostředníka, že je necenzurovatelný, není předmětem inflace a že poplatky jsou nižší než u tradičního bankovního systému. Poté jim můžete **dát leták**, například "21 důvodů, proč používat Bitcoin" a/nebo "10 důvodů, proč akceptovat Bitcoin ve vašem obchodě", a poté **dát jim svůj kontakt nebo kontakt vašeho setkání**. Takto, když budou mít zájem o demonstraci, mohou vás kontaktovat.

3) jakmile se tato osoba rozhodne akceptovat Bitcoin, **nastavení schůzky s ní, aby jste jí ukázali softwarové řešení, které navrhujete, se jeví jako vhodné**. **[Swiss Bitcoin Pay](https://swiss-bitcoin-pay.ch/)** se v tomto ohledu jeví jako vynikající řešení, protože:
- umožňuje obchodníkům, kteří si přejí převést své denní výdělky v bitcoinech na fiat měnu, tím umožňuje platit svým dodavatelům;
- umožňuje také, pokud je to žádoucí, ponechat určité procento příjmů v BTC;
- umožňuje export účetnictví pro všechny platby v bitcoinech, aby je bylo možné poslat účetním, čímž jim usnadňuje práci;
- má uživatelsky přívětivý dashboard pro manažera;
- ale také ergonomické a snadno použitelné rozhraní pro zaměstnance, kteří budou moci zpracovávat platby, aniž by mohli vzít pokladnu s sebou;
- nakonec, jeho používání je levnější než tradiční bankovní síť 2 až 3 %.

4) **když tento podnik akceptuje Bitcoin**, pak bude pro vás možné:
- **pravidelně navštěvovat** pro nákupy;
- využít příležitosti **zeptat se, zda je vše v pořádku**, dokonce znovu nabídnout svůj kontakt, pokud je to potřeba;
- **znovu navrhnout účast na vašich setkáních a akcích**;
- přidat tento podnik na [mapu btcmap.org](https://btcmap.org/) a informovat [Swiss Bitcoin Pay na Twitteru](https://x.com/swissbitcoinpay), aby zvýšili viditelnost tohoto podniku; - ale také **potenciálně pořádat v tomto podniku akce**, jako jsou setkání nebo workshopy.

![obrázek](assets/fr/chapter34/57.webp)

5) Jakmile bylo v vašem městě zaregistrováno několik podniků a ty pochopily, co jim Bitcoin přináší, můžete poté **navrhnout vytvoření speciální Telegramové skupiny pro obchodníky**; cílem je **umožnit jim vzájemně si pomáhat** a jít dále v oranžovém osvětlování dalších podniků ve městě. Paralelně může tato skupina také **působit jako technická podpora**, v případě, že by vznikl problém se zákazníkem.
####
Samozřejmě, **toto oslovování je dlouhodobá práce. Vyžaduje hodně času, zvýšenou motivaci, ale také trochu strategie**.
Cítí vaše komunita připravenost vybudovat ve vašem městě **základy Bitcoinové cirkulární ekonomiky**, podobně jako [Arnhem v Nizozemsku](https://www.arnhembitcoinstad.nl/)? Pokud ano, pusťte se do toho!

## Kontaktování místního tisku a rádia
<chapterId>435bfbc1-22dd-59bb-b737-a32ea995b238</chapterId>

Velmi často zapomenuté, my bitcoinisté obecně si myslíme, že nejlepším prostředkem komunikace jsou sociální sítě a internet. Ale jsme – částečně – na omylu.

Několik komunit (to je případ zejména [Breizh Bitcoin](https://breizhbitcoin.com/), ve Francii) si tak zvyklo **kontaktovat svůj místní tisk** za účelem:
- **Mluvit s nimi o akcích, které organizují** (setkání, prezentace, workshopy, večírky halvingu atd.);
- **Pozvat je k prozkoumání místních podniků, které přijímají Bitcoin, s cílem napsat o tom článek**;
- ale také, jednoduše, **požádat je, aby sdíleli datum a místo svých nadcházejících akcí**.

Skutečně, mnoho místních novin stále má na své poslední nebo předposlední stránce seznam akcí organizovaných v regionu.
Zpětná vazba od Breizh Bitcoin je jasná: funguje to dobře a na jejich setkání přišli noví lidé, kteří se o jejich asociaci dozvěděli v novinách.

Ačkoliv to může být specifické pro lokalitu, ve které se nacházíte, zde je seznam hlavních regionálních francouzských tiskových titulů:
...
Paralelně může být také zajímavé **kontaktovat místní rozhlasové stanice, s návrhem například na vytvoření podcastu nebo rozhovoru**.
Nicméně buďte si vědomi, že slova v médiích mohou být snadno obrácena proti vám. **Takže to není snadný úkol a může být moudré na to připravit se**.

![obrázek](assets/fr/chapter35/58-fr.webp)
####
Samozřejmě, **může být realizováno mnoho dalších projektů**. Obecně bude vše záviset na vašem čase, vaší motivaci; ale také na obtížnosti daného projektu.
Při realizaci těchto, **tři rady** vás mohou vést:
1) **předem definovat kroky projektu, jeho cíl(e) a co je třeba udělat**;
2) **postupujte krok za krokem, aniž byste se nechali odradit**; 3) a především, **žádejte o pomoc a podporu od vašich členů a dalších komunit ve vašem okolí**.

Mějte na paměti, že **každá komunita a setkání prošly stejnými fázemi, kterými právě procházíte**. Takže neváhejte **žádat je o radu**.

# Předvídání budoucnosti
<partId>6ea07445-9369-54bc-9aa0-d260db026e0b</partId>

## Plánování nárůstu účastníků
<chapterId>8af722d4-3a9f-548c-9001-424f2142de12</chapterId>

Jak svět vstoupil do své čtvrté éry, na bloku 840 000, čím dál více lidí vidí **Bitcoin jako technologickou, finanční a sociální revoluci**.
Stejně jako internetová revoluce, i tato bude nutně **trvat určitý čas**, a to je dobře. Umožní to každému **seznámit se se základy Bitcoinu a naučit se, jak ho používat**. Ale také to dá vývojářům a společnostem čas na vývoj relevantních protokolů a aplikací, což umožní prozkoumat plný potenciál Bitcoinu.
Ačkoliv je nemožné předpovědět budoucnost, **je třeba očekávat velmi významný nárůst počtu uživatelů Bitcoinu**, aby bylo možné **být připraveni na všechny situace**. Včetně těch nejkatastrofičtějších, jako je potenciální imploze tradičního finančního systému; nebo dokonce: zákaz Bitcoinu.

V této osmé a poslední části kurzu si vyhradíme čas na detailní probrání některých bodů, které je třeba zvážit při rozvoji vaší komunity a vašich setkání.
####
První z nich (nejlehčí k předvídání) je samozřejmě **nárůst počtu lidí připojujících se k vaší komunitě**. To ovlivní dva aspekty:

1) **vaše komunikační kanály (Telegram, Signal, Matrix atd.) se zaplní, což může ztížit sledování konverzací**. Dva body jsou pak k zvážení.
Na jedné straně, pokud se 500 lidí vyměňuje na různá témata ve stejném diskusním kanálu, většina vašich členů postupně přestane konverzace sledovat; mimo jiné kvůli nadbytku zpráv ke čtení a s nimi spojených oznámení. V tomto smyslu by mohlo být relevantní **přehodnotit vaše komunikační kanály; jako například Telegram super-skupiny, nebo dokonce server na Discordu**, které oba umožňují seskupovat konverzace podle tématu.
Na druhé straně, více lidí v komunikačních kanálech také znamená více botů, více podvodů a také **více moderování**. Budete tedy muset být připraveni, například vypracováním sady pravidel, na která se můžete spolehnout při moderování zprávy. Zkušenosti ukazují, že toto vyřeší velkou část konfliktů; zejména když jsou pravidla k dispozici ke čtení na vašich komunikačních kanálech. V tomto smyslu asociace Bitcoin Lille napsala před několika lety **[sadu pravidel s otevřeným zdrojovým kódem](https://bitcoinlille.fr/reglement/) pro svou skupinu na Telegramu a svůj server na Discordu**, založenou na jednoduchých a univerzálních principech. Její design je [také dostupný](https://www.canva.com/design/DAGHI692AD4/rjT4sqEnhajc5FiPA6GFZQ/edit?utm_content=DAGHI692AD4&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton).

![obrázek](assets/fr/chapter36/59-frbis.webp)

2) **vaše setkání a akce se výrazně zaplní, s množstvím nových tváří, které si chtějí navzájem vyměňovat zkušenosti**.
Vzhledem k tomuto významnému přílivu lze diskutovat a zvážit několik přístupů:
- Zaprvé, může být relevantní **najít větší místo pro organizaci setkání a akcí**, zejména pokud jste v předchozím prostoru mohli ubytovat pouze kolem dvaceti lidí; - Zadruhé, pokud si všimnete, že lidská přítomnost se stává příliš přetěžující, můžete také – pro následující setkání – **buď vyžadovat registraci účastníků** (to lze provést prostřednictvím aplikace Meetup nebo prostřednictvím standardního formuláře), **nebo organizovat více setkání během měsíce** (například: setkání pro začátečníky, pokročilé a expertní);
- Navíc je jisté, že se k vám připojí mnoho začátečníků v ekosystému, obecně s cílem vydělat peníze. **Aby se během těchto rychle rostoucích setkání konverzace zaměřovaly na Bitcoin**, doporučuje se:
    a) **provést tematickou prezentaci o Bitcoinu během těchto setkání**, což následně povede dobrý díl účastníků k diskusi na toto téma, a ne o takzvaně revolučním novém projektu;
    b) **neomezovat se pouze na bitcoinery, ale přistupovat k nováčkům, i kdyby to znamenalo iniciativu zůstat vzadu v místnosti, aby je přivítali**. Diskuse se pak mohou točit kolem důvodů, proč tyto osoby přišly, co hledají, cíle (nebo základy) vaší komunity atd.
####
Nakonec, i když je to bohužel nutné říci, **na setkáních se mohou objevit podvodníci**. Jejich cílem pak bude mluvit co nejvíce o svém Ponziho schématu, MLM, nebo jejich "revolučním blockchainovém projektu". Je také zcela pravděpodobné, že lidé se špatnými úmysly mohou přijít speciálně kvůli praní peněz nebo k nákupu BTC za falešné bankovky.
V složitých situacích, jako jsou tyto, je nejjednodušší přístup "laskavě" vysvětlit těmto jedincům, že setkání není místo, kde uspějí, prezentací argumentů x nebo y (například informováním o přítomnosti tajné policie).
Pokud tyto osoby odmítnou odejít nebo dodržovat pravidla slušnosti (což se již stalo), může být během setkání učiněno ústní oznámení, že jeden nebo více jedinců se pokouší zapojit do takových škodlivých činů.
**Naštěstí jsou tyto situace vzácné a obvykle poměrně zvláštní. Ale je lepší být připraven.**
Navíc, pokud vás to jako organizátora může uklidnit, pokud sami neporušujete zákon nebo neusnadňujete nelegální výměny, nemusíte se obávat. Ve Francii skutečně nejste právně odpovědní za činy ostatních.####
V ideálním světě by tedy bylo nejlepší mít místo, které může ubytovat několik desítek lidí (v závislosti na růstu vaší komunity); ale také, **vybudovat silné vztahy mezi bitcoinery a budoucími bitcoinery během medvědího trhu**, abyste byli připraveni **přesvědčit o Bitcoinu během příštího býčího trhu**.

## Decentralizace organizace vaší komunity
<chapterId>bedfc110-e099-58f4-a5b7-fb50f3b19a49</chapterId>

Jste organizátorem setkání a ze dne na den **se rozhodnete tuto úlohu zastavit** a jít chovat lamy v Peru; prostě nechat vše za sebou?

**Zvažte předání vaší komunity**:
1) **předáním administrativních (nebo dokonce vlastnických) práv komunikačních kanálů důvěryhodným osobám**, i kdyby to znamenalo pozdější změnu vlastníka;
2) **sdílením s alespoň jednou důvěryhodnou osobou ve vaší komunitě názvů účtů, hesel a e-mailů účtů a sociálních sítí**, které jste vytvořili pro zviditelnění.
Bez těchto práv a identifikátorů bude pro kohokoli nemožné **snadno převzít a tím pokračovat v iniciativě, na které jste strávili tolik času jejím rozvíjením**. Začínat od nuly tím, že vytvoříte "forkované" sítě a kanály, skutečně zabere tolik času a tolik energie...

**Tak předvídejte svůj možný odchod** do Peru. A pokud nemáte ve Francii žádného důvěryhodného člena vašeho setkání, můžete vždy kontaktovat @ProfEduStream nebo @gabtribe na Telegramu, aby tento přechod proběhl hladce.
####
To nás přivádí k **základnímu bodu ve vývoji komunity: její decentralizaci**.
Pokud jste v ní totiž jedinou zapojenou osobou a máte všechny kontroly, co se stane, když zmizíte? Odpověď je jednoduchá: vaše komunita zmizí.

Nejlepším způsobem, jak tomu předejít, je tedy **decentralizovat úkoly a sdílet práva, role a přístupy**. Takže pokud jeden z členů organizačního týmu vaší komunity nebo setkání bude zatčen v budoucí dystopii, protože vlastní ne-KYC Bitcoin (nebo prostě: protože již nemá čas věnovat se tomu, protože právě měl dítě nebo změnil práci), ostatní mohou pokračovat ve svých misích bez obtíží.
####
S cílem decentralizovat ještě více, **používání open-source softwaru, jako je sada framasoft**, může také představovat první "linii obrany" proti fiktivnímu státu, který by cenzuroval Bitcoin. Používání šifrovaných - dokonce anonymních - komunikačních nástrojů je druhou.

## Co když se Bitcoin stane veřejným nepřítelem č. 1?
<chapterId>c739651f-cd13-51e0-a36e-85023749b15b</chapterId>

Dne 5. dubna 1933 podepsal Franklin Roosevelt, tehdejší 32. prezident Spojených států amerických, exekutivní příkaz 6102, který zakazoval jakékoli jednotlivci vlastnit zlaté mince, zlaté slitky a zlaté certifikáty na celém území.

![image](assets/fr/chapter37/60-enbis.webp)

Samozřejmě, Velká deprese (krach na burze v roce 1929) dnes již není relevantní. Ale kdo může říci, že zítra nebude další stát dělat totéž a **zakázat jakékoli jednotlivci vlastnit bitcoin?**
####
Naštěstí tato orwellovská dystopie nikomu nezabrání skutečně vlastnit jeho bitcoiny, protože je nemožné zabránit někomu naučit se sekvenci slov.
Ale co se stane, **pokud lídři našeho světa nakonec pochopí, že Bitcoin má kapacitu změnit světový řád, včetně na státní úrovni?** Stane se Bitcoin potom **"veřejným nepřítelem č. 1"?**
####
Samozřejmě bychom neměli upadat do formy konspiračního myšlení. Ale **nic nám nebrání, abychom již nyní předvídali, decentralizovali a vzdělávali**.
...
## Souhrnný akční plán pro vytvoření vaší Bitcoin komunity
<chapterId>1f463ec2-3f64-5641-8d60-e02a47c94f27</chapterId>

Satoshi Nakamoto vytvořil revoluční nástroj, který má kapacitu změnit svět, jak ho známe. Je však jisté, že **na nás, bitcoinerech, je, abychom si vybrali trajektorii, kterou si přejeme vzít pro budování budoucnosti**.
Paralelně, podstata Bitcoinu jej činí obrovskou zajímavostí, která se protíná s mnoha historickými, ekonomickými, literárními, matematickými, informatickými a kryptografickými aspekty, takže je nemožné pokrýt to vše. To částečně tvoří jeho krásu. Jako lidské bytosti máme jen omezené množství času během našich životů. **Je to skromností a učením se od ostatních**, že každý z nás bude schopen dosáhnout cílů, které jsme si v rámci pochopení Bitcoinu stanovili.
**Globální komunity Bitcoinu proto hrají zásadní roli ve vytváření světa zítřka**; komunity, ve kterých mohou bitcoinisté **vyměňovat, budovat a sdílet**. **Společně**.
####
Jak jste již z tohoto kurzu pochopili, **vytvoření komunity a setkání věnované Bitcoinu** vyžaduje organizaci a motivaci. Samozřejmě, v závislosti na vašich touhách a čase, který tomu můžete věnovat, se do projektů pustíte více či méně.
Cíl zůstává stejný: **rozdmýchat jiskru pro růst Bitcoinu ve vašem městě**.
####
Abych shrnul mnoho kapitol a podkapitol tohoto kurzu, zde je **souhrn "plánu akce" pro vytvoření vaší Bitcoin komunity**:
1) rozhodněte dopředu, proč chcete vytvořit Bitcoin komunitu, za jakým účelem, kde atd.;
2) přiblížte se již existujícím komunitám kolem vás tím, že navážete kontakt a/nebo požádáte o radu;
3) vytvořte jedinečnou identitu pro vaši komunitu a její umístění (logo, plakát, banner, leták atd.)
4) vytvořte komunikační kanály a sociální sítě jako Telegram, Twitter, NOSTR, Discord. Zvažte také decentralizované a/nebo necenzurovatelné kanály;
5) oslovte sousední setkání a komunity (zejména na sociálních médiích) a nechte se zapsat na různé mapy a platformy pro získání viditelnosti;

Jakmile jsou komunikační kanály vaší komunity dostatečně rozvinuté:

6) navrhněte setkání typu meet-up prostřednictvím ankety;
7) zamyslete se nad cíli, které chcete z tohoto fyzického setkání dosáhnout;
8) hledejte dobře umístěné, přívětivé místo, které splňuje vaše cíle, a rezervujte stůl;
9) týden před akcí komunikujte o ní na vašich sítích a komunikačních kanálech. Opakujte to dva až tři dny před klíčovým datem;
10) nechte svou akci zapsat na vhodných platformách a webových stránkách, pokud je to možné;
11) v den setkání nechte věci plynout a jděte mezi lidi, i když to znamená jemně nasměrovat konverzaci zpět, pokud je to nutné;

Následně:

12) snažte se udržet a zapojit co nejvíce členů a účastníků, aby se vrátili;
13) Navrhněte nápady na projekty a jednoduché iniciativy a začněte realizovat ty, které jsou pro vás osobně důležité. Pokud někdo jiný chce založit něco jiného, neváhejte mu pomoct na základě úkolu a požadovaného cíle;
Nakonec:

14) Předvídejte budoucnost tím, že zvážíte větší místo pro setkání, pravidla pro komunikační kanály, webové stránky atd.;
15) Začněte demokratizovat přijetí Bitcoinu v podnicích ve vašem městě tím, že se zeptáte, zda Bitcoin přijímají, například;
16) Decentralizujte úkoly mezi důvěryhodné jednotlivce, stejně jako práva na vaše kanály a sítě;
17) Propagujte svou komunitu, aby se přidávalo čím dál více lidí, a zapojte zájemce;
18) Jděte ještě dále s projekty, které máte rádi a na kterých vám záleží.

V mírně méně podrobné formě, ve 21minutovém videu, to vypadá takto:
<videoId>56e302c2-b42c-4a4e-88fc-af207232f5ae</videoId>
####
Bez ohledu na to, **pamatujte, že nejste sami a že existující komunity jsou zde, aby vám pomohly**.

## BTC302 Kurz
<chapterId>8bf10b77-80ee-5d50-87bc-0ef32574a675</chapterId>
V tomto kurzu BTC302 jsme podrobně popsali kroky pro vytvoření komunity, setkání; ale také implementaci mnoha projektů.

Když se vaše komunita cítí připravena přejít na další úroveň, **je možné založit asociaci**.
Ve Francii například z asi padesáti komunit a setkání existuje téměř deset asociací.
####
Zájem o založení asociace je dvojí:
- na jedné straně status asociace umožňuje **mít oficiální status, otevřít asociativní bankovní účet a také získat určitou formu uznání od tisku, médií a dotací**;
- na druhé straně to umožňuje **přesnější organizaci provozu komunity a realizaci jejích projektů** tím, že se stanoví konkrétní role.
####
...
V rámci něj **také podrobněji rozebereme další důležitý bod: organizaci velkých akcí s přibližně stovkou účastníků**. Budeme řešit otázky jako: Proč? Jaká organizace? Kde? Jaký rozpočet? Jak? Jaký provoz?
K tomu využijeme zkušenosti několika francouzských komunit, které již své akce uspořádaly, jako například **BEF (Bitcoin Economic Forum, v květnu v Bretani) a B-only (v listopadu v Annecy)**.

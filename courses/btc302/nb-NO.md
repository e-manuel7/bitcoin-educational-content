...
Dessuten, **siden Bitcoin er inkluderende, ser det ut til å være rollen til et samfunn å myndiggjøre og utdanne alle fremtidige bitcoinere om grunnleggende prinsipper for Bitcoin**; inkludert de mest motvillige.
####
...
Før du kommer i gang, er det imidlertid essensielt å forutse det neste steget: et potensielt møte. Et meet-up, med andre ord!
...
For å hjelpe deg, har vi listet opp noen refleksjoner nedenfor som kan være nyttige.
####
...
For å skape sin visuelle identitet, er den beste tilnærmingen å starte med et betydelig element eller sted fra din by. Dette kan være, for eksempel, Eiffeltårnet i Paris, belfortet eller citadellet i Lille, det monegaskiske fjellet i Monaco, den gamle havnen i Marseille, osv.
...
Til slutt er det også mulig å søke på hjemmesiden etter en **forhåndsdesignet YouTube-miniatyrbilde eller banner**, duplisere den, og deretter modifisere den som du ønsker.
...
Men, når du lager dine visuelle elementer, vær sikker på å være oppmerksom på dimensjonene som forventes av sosiale nettverk og kommunikasjonsapplikasjoner du planlegger å bruke.
...
Avhengig av din tid og ønsker, kan du senere utvikle andre nettverk; til og med **tildele moderering til fremtidige medlemmer av ditt samfunn**.
...
## Sette opp din Telegram-gruppe eller supergruppe
...
Som nevnt tidligere i denne seksjonen, er Twitter og Telegram de to hovedkommunikasjonskanalene som brukes i Europa (og muligens i verden).
...
# Organisering av et Bitcoin Meet-up
...
Å søke etter et sted for å organisere arrangementene dine er ikke nødvendigvis enkelt. Det virker imidlertid essensielt **at dette stedet er lokalisert i byen til samfunnet ditt**.
...
Åpenbart har hver deltaker sin egen personlighet, sensitivitet, mål og interesser. Derfor vil hver oppleve møtet forskjellig.
...
Når møtene dine blir regelmessige og en kjernegruppe på omtrent ti personer har blitt etablert, vil du nå kunne **holde en presentasjon på hvert av møtene dine**. Disse kan da være **tematiske**, med et tema annonsert på forhånd; ettersom de kan være urelaterte til hverandre.
...
De eneste grensene å sette er de for din fantasi!
...
Å lage flygeblader er et tidkrevende steg. Men, det tillater å ha **et papirstøtte under diskusjoner om Bitcoin**, noe som er ganske verdsatt.
...
Hver bitcoiner har helt sikkert allerede sett den svært interessante miniserien "The Satoshi Mystery, at the Origins of Bitcoin" av [Rémi Forte](https:/https://twitter.com/forteremi).
Utgitt i 2021, har den blitt sett [flere millioner ganger på YouTube](https://www.youtube.com/watch?v=0ETcLj5jBy4), da den er et stimulerende første skritt for å forstå hvor Bitcoin kommer fra.
I denne forstand er det helt mulig å **foreslå en videovisning av denne miniserien til ditt samfunn**; til og med skape en spesiell hendelse for eksempel.

Det er imidlertid en liten hake: i Frankrike kontaktet vi ARTE for å verifisere om dette var juridisk mulig. Dessverre, på grunn av **visningsrettigheter**, var kostnaden per visning nesten 250€; med en mulig rabatt på 120€ per visning hvis 5 møter gjorde en innen året.
Følgelig, for det store flertallet av samfunn, er denne prisen forbydende. Likevel er dokumentaren tilgjengelig gratis på ARTE...
####
...
Som nevnt tidligere, har den franske Bitcoin-entusiasten [@Mill3sim3](https://twitter.com/Mill3sim3) det passende profesjonelle utstyret. Derfor kan du kontakte ham på Twitter for informasjon.

## Å ha et tilpasset NFC-kort
<chapterId>8ad65d4e-a68a-59c2-a812-85f4907ed9f3</chapterId>
Et annet unikt prosjekt er **skapelsen av personlige NFC-kort for betalinger ved bruk av Lightning**, i tråd med BoltCard-standarden. For dette formålet er **Swiss Bitcoin Pay** en kvalitetspartner.
...
Denne ideen kan åpenbart tas og forbedres på som du ønsker.

## Å opprette et nettsted
<chapterId>9a2a1b9b-0633-544a-b331-c06187d23d7f</chapterId>
Med målet om å ha et utstillingsvindu for ditt samfunn, møter, arrangementer og utdanningsdokumenter, kan det på et tidspunkt være relevant å **ha en nettside**. Imidlertid **tar det mye tid å designe** (flere titalls timer).
...
[Uncode-pluginen](https://undsgn.com/uncode/), som er betalt, er en av dem.

## Opprette en videokanal (YouTube eller Odyssee)
<chapterId>076286db-1627-57ec-a410-c44b1666e1cd</chapterId>

Blant medlemmene av samfunnet ditt, kan noen være interessert i å **skape multimedieinnhold**. Dette kan for eksempel ta form av å produsere opplæringsvideoer (bruk av en programvarelommebok, opplæring for å kjøpe ikke-KYC BTC, osv.)
Parallelt kan det komme en dag når presentasjoner blir gjort på møtene dine. Eller til og med, når samfunnet ditt holder konferanser i høyere utdanningsinstitusjoner og universiteter.

I denne forstand, **når behovet oppstår, kan det være relevant å ha en videokanal som lar deg legge ut alle videoene, presentasjonene og konferansene gjort som en del av dine handlinger og prosjekter på nettet**.
####
Blant de mest kjente videoplattformene finner vi spesielt:
- [**YouTube**](https://www.youtube.com/), som har feilen av **ikke å være motstandsdyktig mot sensur**;
- [**Odyssee**](https://odysee.com/), som er relativt lite brukt, men er **desentralisert** gjennom sin peer-to-peer drift;
- [**peertube**](https://joinpeertube.org/fr_FR), som lar deg opprette din egen videoplattform. Dette er sannsynligvis et skritt over i form av oppsett.
...
Når det gjelder **videoredigering** (hvis det er noen), vil du trenge å ha passende programvare.
Hvis du ikke allerede har en, er ["Wondershare Filmora"](https://filmora.wondershare.fr/) programvaren spesielt effektiv og veldig enkel å bruke; den lar deg gjøre seriøse redigeringer. Dessverre er den betalt (€45 per år). Til slutt, for **introen og outroen** til videoen din, vil et spesifikt søk på **Canva** tillate deg å finne det du leter etter, modifisere resultatene som du ønsker, laste dem ned; og deretter er alt du trenger å gjøre å integrere dem i redigeringsprogramvaren din.
Merk: i tilfelle at Bitcoin en dag skulle bli forbudt eller sensurert, kan det være relevant å alltid **beholde en lokal kopi på en harddisk av videoene** du legger ut.

## Lage en lydpodcast
<chapterId>12e96b45-1c33-5687-a753-80d0114d487a</chapterId>

Å lage en lydpodcast kan også være en interessant initiativ. Som med å opprette en videokanal, forvent imidlertid ikke å få tusenvis av visninger raskt.

Blant de mest kjente podcast-plattformene finner vi:
- [**Fountain**](https://www.fountain.fm/), som er spesielt interessant fordi den tillater direkte donasjoner i Lightning;
- [**Soundcloud**](https://soundcloud.com/);
- [**Deezer**](https://www.deezer.com/fr/);
- [**Spotify**](https://open.spotify.com/);
- [**Google podcast**](https://podcasts.google.com/).

Problemet er imidlertid at **hver av disse plattformene har et veldig spesifikt publikum**. Så, for å nå så mange mennesker som mulig, vil du trenge å være til stede på omtrent alle av dem.

Heldigvis tillater plattformen **["Spotify for podcasters"](https://podcasters.spotify.com/) deg å importere podcastfilen din én gang, og deretter generere en RSS-feed som kan kopieres og limes inn på noen av de tidligere nevnte plattformene**.
Så, når arbeidet er gjort på "Spotify for podcasters", gjenstår bare formateringen på dine andre plattformer; som er relativt raskt.
####
...
## Lage et merke for dine arrangementer
<chapterId>0cccef8d-a765-5844-8921-c40f0ce653e4</chapterId>

Under dine meet-ups og arrangementer, er det mulig å designe en liten insentiv for å delta. Ideen ville da være å **lage en type merke som bare kan oppnås ved det aktuelle arrangementet**. Dette eksisterer under navnet "POAP" ("Proof Of Attendance Protocol") på andre blokkjeder. Imidlertid er det for øyeblikket ingen gratis måte å sette dette opp på Bitcoin.
I prinsippet kan dette initiativet også tjene til å **belønne de mest engasjerte medlemmene av samfunnet ditt, for eksempel ved å organisere et årlig lotteri**, der en oppnådd merkevare tilsvarer en lodd. Et medlem som er til stede på alle 12 møtene i året, vil da ha 12 lodd for dette årlige lotteriet.####
I tillegg, i en helt annen åre, er det også mulig **på hvert arrangement å be deltakerne om å skrive sitt fornavn eller pseudonym på en merkevare**. Til dette kan grunnene til deres deltakelse også legges til.
Denne strategien, selv om den er litt formell, kan gjøre det mulig for noen medlemmer å **lettere finne felles grunnlag og samtaleemner**, samtidig som det gjør det **enklere for nykommere å identifisere arrangørene** og potensielle medlemmer av foreningen.
...
Et annet punkt på en helt annen note er holdningen til **dødsfallet til et medlem av ditt Bitcoin-samfunn**.
Det kan dessverre komme en dag når familien til et av dine tidligere medlemmer kontakter deg for å kunngjøre at denne personen har gått bort. De vil da forklare at **denne personen etterlot instruksjoner**, og en av dem er å **ta kontakt med ditt samfunn / møte / forening**.
Denne personen vil sannsynligvis forklare at de **trenger hjelp til å gjenopprette midlene**, ettersom de er arvingen til dette tidligere medlemmet.

Som respons på denne forespørselen, kan det være veldig relevant å **allerede ha tenkt på en slags prosedyre å følge**; og dette, av flere grunner.
På den ene siden:
- for å sikre at den avdøde hadde tenkt på forhånd å **informere sin familie om aldri å avsløre eller ta med til et møte de private nøklene og den fysiske lommeboken(e) til den avdøde**;
- slik at familien klart forstår at **deres deltakelse handler om å lære om Bitcoin**, for å til slutt bli suverene over den avdødes midler;
- slik at **familien er klar over loven som gjelder i landet i tilfelle donasjon, arv, eller konvertering til fiat-valuta**;

Videre sikrer det å tenke på forhånd om en prosedyre å følge også at ingen, enten et medlem av møtet eller bare en gjest, kan bruke denne situasjonen på noen måte til sin fordel (og/eller for å stjele midlene).

Mot dette målet kan det være interessant å **foreslå en "arbeidsgruppe" om prosedyren å adoptere i tilfelle død og forespørsler om hjelp som kommer fra familien**. Bitcoin Lille-foreningen jobber faktisk med dette punktet, og den vil dele sitt endelige arbeidsdokument på en åpen kildekode-måte [her](https://docs.google.com/document/d/1TDfLZjuictC5s3PEM2Z7WmkxIDSJ8Q1E4xevm52pVgU/edit?usp=sharing) om noen måneder.

## Gjennomføre konferanser i skoler og universiteter
<chapterId>65efdb44-e3d4-567c-aedf-972765753d73</chapterId>
Listen over prosjekter som tidligere er beskrevet er åpenbart ikke uttømmende. Generelt er dette prosjekter internt i fellesskapet/møteplasser, og kan ganske enkelt settes opp når fellesskapet ditt har utviklet seg. Det er derfor på tide nå å ta for seg onboarding.

Først og fremst er du utvilsomt klar over at **en av de beste måtene å snakke om Bitcoin til så mange mennesker som mulig på samme tid, er åpenbart å holde en konferanse** (eller en workshop). Dette kan gjøres **innenfor høyere utdanningsinstitusjoner og universiteter**; og dermed lede unge (og kanskje ikke så unge) mennesker til å oppdage eller fordype sin forståelse av Bitcoin.

I tillegg til viktigheten av **å vite hvordan man snakker i offentligheten**, krever det å være vert for en konferanse foran flere dusin eller til og med hundrevis av mennesker **å vite hvordan man håndterer stress, artikulasjon og tid**. Det krever også **å forberede en kvalitetspresentasjon eller workshop, som er kildesøkt og i tråd med publikums ferdighetsnivå** du vil stå overfor.
Videre er **å ha et åpent tankesett, klar til å forenkle konsepter etter behov**, essensielt i denne typen øvelse; spesielt under spørsmål/svar-fasen og i tilfelle av en paneldiskusjon. Dette betyr ikke "å forlate dine prinsipper"; men rett og slett å akseptere at andre kan ha et annet synspunkt, selv om det betyr å svare senere eller la det gå slik at dialogen kan gå fremover. Uansett, hvis **din tale og dine svar er basert på relevante og kildesøkte argumenter**, vil ikke publikum bli lurt.
...
I tilfellet med en post-baccalaureate skole, er det også mulig å **kontakte personen som er ansvarlig for opplæringsprogrammet direkte**, med mål om å forklare ditt forslag. Dette kan deretter føre til et første møte og – i den beste av verdener, noen uker senere – til en presentasjon om hva Bitcoin er og hvordan det fungerer foran studentene.
####
...
Å oppnå målet om å **få Bitcoin akseptert som betalingsmetode hos en handlende** er på en måte den "hellige gral" for mange Bitcoin-entusiaster. Det er som å låse opp en prestasjon i deres Pokédex! Imidlertid, siden hver handlende er forskjellig, er denne oppgaven ikke enkel; og mange problemer oppstår:
- **en handlende trenger fortsatt fiatvaluta for å betale sine leverandører (foreløpig)**;
- **de trenger klare og eksplisitte finansielle rapporter** som kan sendes til deres regnskapsførere;
- **deres betalingsmetoder må fungere uten tekniske eller logistiske problemer**, og ansatte må kunne motta betalinger uten å kunne stikke av med kassaapparatet.

Til disse problemene, legg til:
- **de potensielle fordommene** handlende har mot Bitcoin;
...
1) så snart du går inn i en butikk, **spør alltid om du kan betale med Bitcoin**. Dette vil generelt resultere i et avslag og et spørrende blikk, men dette enkle spørsmålet vil gradvis føre til at handlende ser at Bitcoin kan brukes av "normale mennesker" og at det vekker interesse som betalingsmetode blant befolkningen. Du kan til og med **rotere to eller tre personer på samme butikk, noen dager fra hverandre, som spør om å betale med Bitcoin**. På et tidspunkt vil dette fange handlendes oppmerksomhet;

2) når de blir interesserte eller spør hva Bitcoin er, kan du **forklare det for dem kortfattet og i lekmanns termer**. For eksempel, at Bitcoin er en valuta, ikke kontrollert av banker, uten en betrodd mellommann, at den er usensurerbar, ikke underlagt inflasjon, og at gebyrene er lavere enn med det tradisjonelle banksystemet. Du kan deretter **gi dem en flyer**, for eksempel, "21 grunner til å bruke Bitcoin" og/eller "10 grunner til å akseptere Bitcoin i din butikk", og deretter **gi dem din kontakt eller den til ditt meet-up**. Slik at når de er interesserte i en demonstrasjon, kan de kontakte deg.

3) når denne personen har bestemt seg for å akseptere Bitcoin, **virker det passende å sette opp et møte med dem for å vise programvareløsningen du foreslår**. **[Swiss Bitcoin Pay](https://swiss-bitcoin-pay.ch/)** presenterer seg som en utmerket løsning i denne forbindelse, fordi:
- det lar handlende som ønsker å konvertere deres daglige bitcoin-inntekter til fiatvaluta, noe som gjør det mulig for dem å betale sine leverandører;
- det tillater også, om ønskelig, å beholde en viss prosentandel av inntektene i BTC;
- det muliggjør eksport av regnskapet for alle bitcoin-betalinger for å sende det til regnskapsførere, og dermed gjøre deres arbeid enklere;
- det har et brukervennlig dashbord for lederen;
- men også et ergonomisk og enkelt å bruke grensesnitt for ansatte, som vil kunne behandle betalinger uten å kunne ta av med kassaapparatet;
- til slutt er brukskostnaden mindre kostbar enn det tradisjonelle banknettverkets 2 til 3%.

4) **når denne virksomheten aksepterer Bitcoin**, vil det da være mulig for deg:
- å **jevnlig besøke** for å gjøre innkjøp;
- å benytte anledningen til å **spørre om alt går bra**, til og med tilby din kontakt igjen om nødvendig;
...
####
Selvfølgelig, **er denne oppsøkingen en langsiktig jobb. Det krever mye tid, økt motivasjon, men også litt strategi**.
Føler ditt samfunn seg klart til å bygge i din by **grunnlaget for en Bitcoin sirkulærøkonomi**, lik [Arnhem i Nederland](https://www.arnhembitcoinstad.nl/)? Hvis ja, kjør på!

## Kontakt med lokalpressen og radioen
<chapterId>435bfbc1-22dd-59bb-b737-a32ea995b238</chapterId>

Veldig ofte glemt, vi bitcoiners tror generelt at de beste kommunikasjonsmidlene er sosiale medier og internett. Men vi tar – delvis – feil.

Flere samfunn (dette er tilfellet spesielt med [Breizh Bitcoin](https://breizhbitcoin.com/), i Frankrike) har derfor gjort det til en vane å **kontakte sin lokale presse** for å:
- **Snakke med dem om arrangementene de organiserer** (meet-ups, presentasjoner, workshops, halving-fester, osv.);
- **Invitere dem til å utforske lokale bedrifter som aksepterer Bitcoin, med målet om å skrive en artikkel** om emnet;
- men også, rett og slett, **å be dem om å dele dato og sted for deres kommende arrangementer**.

Faktisk har mange lokale aviser fortsatt, på sin siste eller nest siste side, en liste over arrangementer organisert i deres region.
Tilbakemeldingen fra Breizh Bitcoin er klar: det fungerer godt, og nye personer har deltatt på deres meet-ups etter å ha oppdaget deres forening i avisen.

Selv om dette kan være spesifikt for lokaliteten du befinner deg i, her er en liste over de viktigste regionale franske presse titlene:
...
1) **definer på forhånd prosjektets trinn, dets mål, og hva som må gjøres**;
2) **gå frem steg for steg, uten å bli motløs**; 3) og fremfor alt, **be om hjelp og en hånd fra dine medlemmer og andre samfunn rundt deg**.

Husk at **hvert samfunn og møte har gått gjennom de samme stadiene som du går gjennom**. Så nøl ikke med å **be dem om råd**.

# Forutse Fremtiden
<partId>6ea07445-9369-54bc-9aa0-d260db026e0b</partId>

## Planlegging for en Økning i Deltakere
<chapterId>8af722d4-3a9f-548c-9001-424f2142de12</chapterId>

Ettersom verden har trådt inn i sin fjerde epoke, ved blokk 840,000, ser stadig flere individer **Bitcoin som en teknologisk, finansiell og sosial revolusjon**.
Akkurat som internettrevolusjonen, vil denne nødvendigvis **ta tid**, og det er en god ting. Det vil tillate alle å **utdanne seg om grunnleggende aspekter ved Bitcoin, og lære hvordan man bruker det**. Men også, det vil gi utviklere og selskaper tid til å utvikle relevante protokoller og applikasjoner, som tillater utforskning av Bitcoins fulle potensial.
Selv om det er umulig å forutsi fremtiden, er **en veldig betydelig økning i antall Bitcoin-brukere å forvente**, for å **være forberedt på alle situasjoner**. Inkludert de mest katastrofale, som en potensiell implosjon av det tradisjonelle finanssystemet; eller til og med: et forbud mot Bitcoin.

I denne åttende og siste delen av dette kurset, vil vi ta oss tid til å detaljere noen punkter å vurdere når du utvikler ditt samfunn og dine møter.
####
Det første blant dem (det enkleste å forutse) er åpenbart **økningen i antall personer som blir med i ditt samfunn**. Dette vil påvirke det på to måter:

1) **dine kommunikasjonskanaler (Telegram, Signal, Matrix, osv...) vil fylles opp, potensielt gjør samtaler vanskelige å følge**. To punkter er da å vurdere.
...
- For det første kan det være relevant å **finne et større sted for å organisere møter og arrangementer**, spesielt hvis du bare kunne ha plass til rundt tjue personer i det forrige lokalet;
- For det andre, hvis du merker at menneskelig tilstedeværelse blir for overveldende, kan du også – for de følgende møtene – **enten kreve at deltakerne registrerer seg** (dette kan gjøres via Meetup-appen, eller gjennom et standard skjema), **eller organisere flere møter i løpet av måneden** (for eksempel: et møte for nybegynnere, et for mellomnivå, og et for eksperter);
- Dessuten er det sikkert at mange nybegynnere i økosystemet vil bli med dere, generelt med målet om å tjene penger. **For at samtalene skal forbli fokusert på Bitcoin under disse raskt voksende møtene**, anbefales det:
    a) **å gjennomføre en tematisk presentasjon om Bitcoin under disse møtene**, da dette vil føre til at en god del av deltakerne diskuterer dette temaet, og ikke et såkalt revolusjonerende nytt prosjekt;
    b) **ikke bare holde seg med bitcoiners, men å nærme seg nykommerne, selv om det betyr å ta initiativet til å stå bak i rommet for å ønske dem velkommen**. Diskusjonene kan da dreie seg om grunnene til at disse menneskene kom, hva de søker, målene (eller grunnleggende prinsipper) for deres fellesskap, osv.
####
Til slutt, selv om det er trist å si, **kan svindlere dukke opp på møtene**. Målet deres vil da være å snakke så mye som mulig om deres Ponzi-scheme, deres MLM, eller deres "revolusjonerende blockchain-prosjekt". Det er også helt plausibelt at personer med ondsinnede hensikter kan komme spesifikt for å hvitvaske penger eller for å kjøpe BTC med falske sedler.
I komplekse situasjoner som disse, er den enkleste tilnærmingen å ta initiativet til å "vennlig" forklare disse individene at møtet ikke er stedet hvor de vil lykkes, ved å presentere argumenter x eller y (som for eksempel, å informere om tilstedeværelsen av undercover politi).
Hvis, dessverre, disse individene nekter å forlate eller å overholde anstendighetsreglene (som har skjedd før), kan en muntlig kunngjøring under møtet informere om at en eller flere personer forsøker å engasjere seg i slike ondsinnede handlinger.
**Heldigvis er disse situasjonene sjeldne og vanligvis ganske spesielle. Men det er bedre å være forberedt.**
Dessuten, hvis det kan berolige deg som arrangør, så lenge du ikke selv bryter loven eller letter ulovlige utvekslinger, trenger du ikke å bekymre deg. I Frankrike er du faktisk ikke juridisk ansvarlig for andres handlinger.####
I en ideell verden ville det derfor være best å ha et lokale som kan romme flere dusin mennesker (avhengig av veksten i ditt fellesskap); men også, å **bygge sterke relasjoner mellom bitcoiners og fremtidige bitcoiners under bjørnemarkedet**, slik at du er klar til å **orange-pille under den neste oksemarkedet**.

## Desentralisering av organiseringen av ditt fellesskap
<chapterId>bedfc110-e099-58f4-a5b7-fb50f3b19a49</chapterId>

Du er arrangøren av et møte og, over natten, **bestemmer du deg for å stoppe denne oppgaven** for å dra og oppdra lamaer i Peru; bare etterlater alt bak?

**Vurder å overlevere ditt fellesskap ved**:
1) **å gi administrative (eller til og med eierskaps) rettigheter til kommunikasjonskanaler til pålitelige personer**, selv om det betyr å endre hender senere;
2) **å dele med minst én pålitelig person i ditt fellesskap konto-navnene, passordene, og e-postene til kontoene og sosiale nettverk** du opprettet for å gi det synlighet.
Uten disse rettighetene og identifikatorene vil det være umulig for noen å **enkelt ta over og dermed fortsette initiativet du hadde brukt så mye tid på å utvikle**. Å starte fra bunnen av ved å opprette "forkede" nettverk og kanaler tar virkelig så mye tid og så mye energi...

**Så forutse din potensielle avreise** til Peru. Og hvis du ikke har noen pålitelig medlem i ditt møte i Frankrike, kan du alltid kontakte @ProfEduStream eller @gabtribe på Telegram for å gjøre denne overgangen smidig.
####
Dette bringer oss til **et avgjørende punkt i utviklingen av et fellesskap: dets desentralisering**.
Faktisk, hvis du er den eneste personen som er involvert i det, med all kontroll, hva vil skje hvis du forsvinner? Svaret er enkelt: ditt fellesskap vil forsvinne.

Den beste måten å unngå dette på er derfor å **desentralisere oppgaver og dele rettigheter, roller og tilgang**. Så, hvis et av de organisatoriske teammedlemmene i ditt fellesskap eller møte blir arrestert i en fremtidig dystopi fordi de eier ikke-KYC Bitcoin (eller rett og slett: fordi de ikke lenger har tid til å vie til det fordi de nettopp har fått et barn eller byttet jobb), kan de andre fortsette sine oppdrag uten vanskeligheter.
####
I mål om å desentralisere enda videre, kan **bruk av åpen kildekode-programvare som framasoft-pakken** også utgjøre en første "forsvarslinje" mot en fiktiv stat som ville sensurere Bitcoin. Bruk av krypterte - til og med anonyme - kommunikasjonsverktøy er en annen.

## Hva om Bitcoin ble offentlig fiende nr. 1?
...
####
Heldigvis vil denne orwellske dystopien ikke hindre noen i å virkelig eie sine bitcoins, da det er umulig å stoppe noen fra å lære en sekvens av ord.
Men hva vil skje **hvis verdenslederne endelig forstår at Bitcoin har kapasiteten til å endre verdensordenen, inkludert på statsnivå?** Vil Bitcoin da bli **"offentlig fiende nr. 1"?**
####
...
## En oppsummert handlingsplan for å skape ditt Bitcoin-fellesskap
<chapterId>1f463ec2-3f64-5641-8d60-e02a47c94f27</chapterId>

Satoshi Nakamoto skapte et revolusjonerende verktøy som har kapasiteten til å endre verden slik vi kjenner den. Det er imidlertid sikkert at **det er opp til oss, bitcoinere, å velge den banen vi ønsker å ta for å bygge fremtiden**.
Parallelt utgjør essensen av Bitcoin et enormt kaninhull som krysser så mange historiske, økonomiske, litterære, matematiske, datavitenskapelige og kryptografiske aspekter at det er umulig å dekke alt. Dette utgjør delvis skjønnheten dens. Som mennesker har vi bare en begrenset mengde tid i løpet av livene våre. **Det er ved å forbli ydmyke og lære fra andre** at hver av oss vil kunne nå målene vi har satt for oss selv i forståelsen av Bitcoin.
**Globale Bitcoin-samfunn spiller derfor en grunnleggende rolle i å bygge morgendagens verden**; samfunn der bitcoinere kan **utveksle, bygge og dele**. **Sammen**.
####
Som du vil ha forstått fra dette kurset, krever **å skape et samfunn og et Bitcoin-møte** organisering og motivasjon. Selvfølgelig, avhengig av dine ønsker og den tiden du har å vie til det, vil du gå mer eller mindre langt i prosjektene.
Likevel forblir målet det samme: **å tenne gnisten for at Bitcoin skal vokse i byen din**.
####
For å oppsummere de mange kapitlene og underkapitlene i dette kurset, her er **en "handlingsplan" oppsummering for å skape ditt Bitcoin-samfunn**:
1) bestem på forhånd hvorfor du vil skape et Bitcoin-samfunn, til hvilket formål, hvor, osv.;
2) kom nærmere allerede etablerte samfunn rundt deg ved å ta kontakt og/eller be om råd;
3) skap en unik identitet for ditt samfunn og dets plassering (logo, plakat, banner, flyer, osv.)
4) skap kommunikasjonskanaler og sosiale nettverk som Telegram, Twitter, NOSTR, Discord. Vurder også desentraliserte og/eller usensurerbare kanaler;
5) nærme deg nabolagets møter og samfunn (spesielt på sosiale medier) og få deg oppført på ulike kart og plattformer for å få synlighet;

Når kommunikasjonskanalene til samfunnet ditt er tilstrekkelig utviklet:

6) foreslå en møte-type samling gjennom en undersøkelse;
7) tenk på målene du ønsker å oppnå fra dette fysiske arrangementet;
8) se etter et godt plassert, innbydende sted som møter dine mål og reserver et bord;
9) en uke før arrangementet, kommuniser om det på dine nettverk og kommunikasjonskanaler. Gjenta dette to til tre dager før den avgjørende datoen;
10) få arrangementet ditt oppført på passende plattformer og nettsteder, om mulig;
11) på dagen for møtet, la ting skje og gå mot andre, selv om det betyr å forsiktig styre samtalen tilbake om nødvendig;

Etterfølgende:

12) søk å beholde og involvere så mange medlemmer og deltakere som mulig slik at de returnerer;
13) Foreslå prosjektideer og enkle initiativer, og start implementeringen av de som personlig er viktige for deg. Hvis noen andre ønsker å sette opp noe annerledes, nøl ikke med å gi en hånd basert på oppgaven og ønsket mål;
Til slutt:

14) Forutse fremtiden ved å vurdere et større lokale for møter, regler for kommunikasjonskanaler, en nettside, osv.;
15) Begynn å demokratisere aksepten av Bitcoin i bedriftene i byen din, ved å spørre om de aksepterer Bitcoin, for eksempel;
16) Desentraliser oppgaver blant pålitelige individer, samt rettighetene til dine kanaler og nettverk;
17) Fremme ditt samfunn slik at flere og flere mennesker blir med, og involvere interesserte individer;
...
I dette BTC302-kurset har vi detaljert trinnene for å skape et fellesskap, et møte; men også, implementeringen av en rekke prosjekter.

Når fellesskapet ditt føler seg klart til å gå til neste nivå, **er det mulig å opprette en forening**.
I Frankrike, for eksempel, av omtrent femti fellesskap og møter, er det nesten ti foreninger.
####
Interessen for å skape en er todelt:
- på den ene siden, tillater statusen som en forening å **ha en offisiell status, åpne en foreningsbankkonto, og også oppnå en form for anerkjennelse fra pressen, media, og subsidier**;
- på den andre siden, muliggjør det **mer presis organisering av fellesskapets operasjoner og implementeringen av dets prosjekter**, ved å definere spesifikke roller.
####
Med målet om å ytterligere blomstre ditt fellesskap, **vil et kurs kalt COMMU201 bli lansert på [planb.network](https://planb.network/) i de kommende månedene**.
